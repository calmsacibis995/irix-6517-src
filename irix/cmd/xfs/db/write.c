	...
	char		**argv)
{
	...
	if (flag_readonly) {
		dbprintf("xfs_db started in read only mode, writing disabled\n");
		return 0;
	}
...
static struct bw_cmd {
	...
	bwrite_lshift, "lshift",   2, 0, 3, 1, 0, 0, 2, 3, "[shiftcount] [start] [len]",
	bwrite_rshift, "rshift",   2, 0, 3, 1, 0, 0, 2, 3, "[shiftcount] [start] [len]",
	bwrite_lrot,   "lrot",     2, 0, 3, 1, 0, 0, 2, 3, "[shiftcount] [start] [len]",
	bwrite_rrot,   "rrot",     2, 0, 3, 1, 0, 0, 2, 3, "[shiftcount] [start] [len]",
	bwrite_seq,    "sequence", 3, 0, 4, 0, 1, 2, 3, 4, "[from] [to] [start] [len]",
	bwrite_random, "random",   3, 0, 2, 0, 0, 0, 1, 2, "[start] [len]",
	bwrite_fill,   "fill",     1, 1, 3, 1, 0, 0, 2, 3, "num [start] [len]"
};
