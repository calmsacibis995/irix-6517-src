#ident  "$Header: /proj/irix6.5.7m/isms/irix/cmd/icrash/cmds/RCS/cmd_debug.c,v 1.12 1999/05/25 19:21:38 tjm Exp $"
...
debug_cmd(command_t cmd)
{
	...
	/* check to see if this is the DC_ALLOC class. If it is then
	 * we have to set the alloc_debug flag.
	 */
	if (d & DC_ALLOC) {
		alloc_debug = 1;
	}
