...
extern int Tclflag;
extern int xlv_mk_new_obj_defined;	/* indicates unsaved objects */

typedef xlv_oref_t xlv_mk_context_t;

#define	XLV_MK_CTXT_FLAG_DIRTY	0x1
#define XLV_MK_CTXT_DIRTY(ctxt)		((ctxt)->flag & XLV_MK_CTXT_FLAG_DIRTY)
#define XLV_MK_CTXT_SET_DIRTY(ctxt)	((ctxt)->flag |= XLV_MK_CTXT_FLAG_DIRTY)
#define XLV_MK_CTXT_UNSET_DIRTY(ctxt)	((ctxt)->flag &=~XLV_MK_CTXT_FLAG_DIRTY)
...
extern int xlv_mk_write_disk_labels (int *write_cnt, int verbose);
...
extern char *xlv_mk_context_name(xlv_mk_context_t *ctxt);
