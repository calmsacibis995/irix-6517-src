 ...
 *
 *	Definitions for the Management Information Base (RFC1066).
 *
 *	$Revision: 1.8 $
 */
...
extern struct tree *init_mib(char *, oid *, int, char *);
extern int read_objid(char *, oid *, int *);
extern void print_objid(oid *, int);
extern void sprint_objid(char *, oid *, int);
struct variable_list;
extern void print_variable(oid *, int, struct variable_list *);
extern void sprint_variable(char *, oid *, int, struct variable_list *);
extern void sprint_value(char *, oid *, int, struct variable_list *);
extern void print_value(oid *, int, struct variable_list *);
extern struct tree *get_symbol(oid *, int, struct tree *, char *);
