...
extern	int			enable_ex_lvl_cnts;
extern	int			enable_ker_lvl_cnts;
extern	int			enable_sup_lvl_cnts;
#ifndef FILTER
extern  hwperf_profevctrarg_t	evctr_args; 
extern  hwperf_cntr_t		cnts;
#endif
...
extern int 
PFX_read_counters_pid(int, evcnt_t *, int, evcnt_t *, pid_t, int, int);
...
extern int
PFX_print_counters_thread( int, int, evcnt_t, int, evcnt_t);

#ifndef FILTER
extern int 
PFX_print_counters_thread_all( int, hwperf_cntr_t *);
#endif
...
extern void
print_table(perfy_option_t *options, counts_t *counts, pid_t pid);
