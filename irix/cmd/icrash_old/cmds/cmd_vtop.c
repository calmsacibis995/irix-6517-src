#ident  "$Header: /proj/irix6.5.7m/isms/irix/cmd/icrash_old/cmds/RCS/cmd_vtop.c,v 1.1 1999/05/25 19:19:20 tjm Exp $"
...
vtop_cmd(command_t cmd)
{
	...
	for (i = 0; i < cmd.nargs; i++) {
		...
		ret = kl_addr_convert(K, vaddr, VADDR_FLAG, &paddr, 
