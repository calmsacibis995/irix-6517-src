...
/*
 * $Id: mace.h,v 1.5 1997/03/21 23:24:07 elin Exp $
 */
...
/********************************
 * Mace Interrupt Assignments for use with setcrimevector and MACE_INTR()
 *
 * PCI interrupts from BRIDGE to SLOT2 are dedicated to their device.
 * Shared PCI intrs are wired as follows:
 ...
 */
#define MACE_VID_IN_1		0
#define MACE_VID_IN_2		1
#define MACE_VID_OUT		2
#define MACE_ETHERNET		3
#define MACE_PERIPH_SERIAL	4
#define MACE_PERIPH_PARALLEL	4
#define MACE_PERIPH_MISC	5
#define MACE_PERIPH_AUDIO	6
#define MACE_PCI_BRIDGE		7
#define MACE_PCI_SCSI0		8
#define MACE_PCI_SCSI1		9
#define MACE_PCI_SLOT0		10
#define MACE_PCI_SLOT1		11
#define MACE_PCI_SLOT2		12
#define MACE_PCI_SHARED0	13
#define MACE_PCI_SHARED1	14
#define MACE_PCI_SHARED2	15
