...
#ifndef _NET_LOOPBACK_TICLTS_H	/* wrapper symbol for kernel use */
#define _NET_LOOPBACK_TICLTS_H	/* subject to change without notice */
#ifdef __cplusplus
extern "C" {
#endif

#ident	"@(#)uts-3b2:net/loopback/ticlts.h	1.2"
/*
