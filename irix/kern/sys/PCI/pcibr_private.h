 ...
 *									  *
 **************************************************************************/
#ifndef __PCI_PCIBR_PRIVATE_H__
#define __PCI_PCIBR_PRIVATE_H__
...
#ident "sys/PCI/pcibr_private: $Revision: 1.35 $"
...
typedef __uint64_t pcibr_DMattr_t;
typedef __uint32_t pcibr_ATEattr_t;
...
#define	bssw_size	w_size
	...
	__uint32_t              bs_errcount_total;
	__uint32_t              bs_lasterr_timestamp;
	__uint32_t              bs_lasterr_snapshot;
