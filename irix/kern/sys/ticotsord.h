...
#ifndef _NET_LOOPBACK_TICOTSORD_H	/* wrapper symbol for kernel use */
#define _NET_LOOPBACK_TICOTSORD_H	/* subject to change without notice */
#ifdef __cplusplus
extern "C" {
#endif

#ident	"@(#)uts-3b2:net/loopback/ticotsord.h	1.2"
/*
...
#define tcoo_mkrqhash(TE)	(((((__psunsigned_t)((TE)->te_rq))*TCOO_RQMAGIC) >> TCOO_RQSHIFT) & TCOO_RQMASK)
