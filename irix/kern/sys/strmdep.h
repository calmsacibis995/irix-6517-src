...
#ifndef _SYS_STRMDEP_H	/* wrapper symbol for kernel use */
#define _SYS_STRMDEP_H	/* subject to change without notice */

#ident	"@(#)uts-3b2:io/strmdep.h	1.2"
...
#define str_aligned(X)	(((__psint_t)(X) & (sizeof(__psint_t) - 1)) == 0)
