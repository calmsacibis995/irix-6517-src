...
/*
 * xbow.h - crossbow chip header file
 */
...
typedef union xbw0_status_u {
	...
	__uint32_t              linkXintr:8,	/* link(x) error intr */
	                        ...
	                        resvd1:17, regacc_err:1,	/* Reg Access error     */
	                        resvd2:2, xtalk_err:1,	/* Xtalk pkt with error bit */
...
typedef union xbw0_ctrl_u {
    xbowreg_t               ctrlword;
    struct {
	__uint32_t              resvd1:26, accerr_intr:1, resvd2:2,
	                        xtalkerr_intr:1, conntout_intr:1, resvd3:1;
    } xbw0_ctrlfield;
} xbw0_ctrl_t;
...
typedef union xbow_linkX_status_u {
    ...
    struct {
	__uint32_t              alive:1, resvd1:12, merror:1, illdest:1,
	                        ioe:1,	/* Input overallocation error */
	                        bw_errport:8,	/* BW allocation error port     */
	                        llp_rxovflow:1, llp_txovflow:1, llp_maxtxretry:1,
	                        llp_rcverror:1, llp_xmitretry:1, pkt_toutdest:1,
	                        pkt_toutconn:1, pkt_toutsrc:1;
    } xb_linkstatus;
} xbwX_stat_t;
...
#define	link_pkt_toutconn	xb_linkstatus.pkt_toutconn
#define	link_pkt_toutsrc	xb_linkstatus.pkt_toutsrc

typedef union xbow_aux_linkX_status_u {
    xbowreg_t               aux_linkstatus;
    struct {
	__uint32_t              rx_err_cnt:8, tx_retry_cnt:8, to_src_loc:8,
	                        rsvd1:1, fail_mode:1, wid_present:1,
	                        bit_mode_8:1, rsvd2:4;
    } xb_aux_linkstatus;
