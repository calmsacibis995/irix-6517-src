...
#ifndef _SYS_STRLOG_H	/* wrapper symbol for kernel use */
#define _SYS_STRLOG_H	/* subject to change without notice */

#ident	"@(#)uts-3b2:io/strlog.h	1.2"
/*
...
#define I_CHKSYSLOGD	(LOGCTL|4)	/* chk if syslogd is running */
