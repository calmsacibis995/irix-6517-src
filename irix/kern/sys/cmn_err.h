...
#define CE_ALERT	LOG_ALERT	/* alert	*/
...
#define CE_PBPANIC	LOG_CRIT	/* Special define used to manipulate
					 * putbufndx in kernel */
...
extern void cmn_err_tag(int, int, char *, ...);
extern void icmn_err_tag(int, int, char *, va_list);
extern void arcs_printf(char *, ...);
