#ifndef __SYS_IOBUS_H
#define __SYS_IOBUS_H
 ...
 * necessary.
 */
extern device_desc_t	device_desc_dup(vertex_hdl_t dev);
extern void		device_desc_free(device_desc_t device_desc);
extern device_desc_t	device_desc_default_get(vertex_hdl_t dev);
extern void		device_desc_default_set(vertex_hdl_t dev, device_desc_t device_desc);

extern vertex_hdl_t	device_desc_intr_target_get(device_desc_t device_desc);
...
extern void		device_desc_intr_target_set(device_desc_t device_desc, vertex_hdl_t target);
