...
#define	WD95A_S_CTL	(0<<ACC_SHIFT)	/* control register */
#define	WD95A_S_SCNF	(2<<ACC_SHIFT)	/* scsi configuration */
#define	WD95A_S_OWNID	(4<<ACC_SHIFT)	/* Own ID register */
#define	WD95A_S_TIMOUT	(6<<ACC_SHIFT)	/* Sel & Resel timout period */
#define	WD95A_S_SLEEP	(8<<ACC_SHIFT)	/* Sleep Countdown register */
#define	WD95A_S_TIMER	(10<<ACC_SHIFT)	/* scsi timeout countdown residue */

#define	WD95A_S_CDBSIZ1	(12<<ACC_SHIFT)	/* Special CDB Size reg (grp 3,4) */
#define	WD95A_S_CDBSIZ2	(14<<ACC_SHIFT)	/* Special CDB Size reg (grp 6,7) */
#define	WD95A_S_IDFLAG0	(16<<ACC_SHIFT)	/* SCSI-ID specific flags (0..7) */
#define	WD95A_S_IDFLAG1	(18<<ACC_SHIFT)	/* SCSI-ID specific flags (8..15) */

#define	WD95A_S_DMACNF	(20<<ACC_SHIFT)	/* DMA Configuration */
#define	WD95A_S_DMATIM	(22<<ACC_SHIFT)	/* DMA Timing control */

#define	WD95A_S_TEST0	(24<<ACC_SHIFT)	/* Factory Test Register */

#define	WD95A_S_SC0	(26<<ACC_SHIFT)	/* SCSI Low-level control */
#define	WD95A_S_SC1	(28<<ACC_SHIFT)	/* SCSI Low-level control */
#define	WD95A_S_SC2	(30<<ACC_SHIFT)	/* SCSI Low-level control */
#define	WD95A_S_SC3	(32<<ACC_SHIFT)	/* SCSI Low-level control */

#define	WD95A_S_CSADR	(34<<ACC_SHIFT)	/* WCS Address Register */
#define	WD95A_S_CSPRT0	(36<<ACC_SHIFT)	/* WCS port for window 0 */
#define	WD95A_S_CSPRT1	(38<<ACC_SHIFT)	/* WCS port for window 1 */
#define	WD95A_S_CSPRT2	(40<<ACC_SHIFT)	/* WCS port for window 2 */
#define	WD95A_S_CSPRT3	(42<<ACC_SHIFT)	/* WCS port for window 3 */
#define	WD95A_S_SQSEL	(44<<ACC_SHIFT)	/* WCS Sel reponse addr */
#define	WD95A_S_SQRSL	(46<<ACC_SHIFT)	/* WCS ReSel reponse addr */
#define	WD95A_S_SQDMA	(48<<ACC_SHIFT)	/* WCS Start addr for DMA req */

#define	WD95A_S_DPRADD	(50<<ACC_SHIFT)	/* DPR address Pointer */
#define	WD95A_S_DPRTC	(52<<ACC_SHIFT)	/* DPR Transfer Counter */

#define	WD95A_S_PLR	(54<<ACC_SHIFT)	/* Physical:Logical Block Ratio */
#define	WD95A_S_PSIZE0	(56<<ACC_SHIFT)	/* Physical Block Size */
#define	WD95A_S_PSIZE1	(58<<ACC_SHIFT)	/* Physical Block Size */

#define	WD95A_S_PING	(60<<ACC_SHIFT)	/* Mirroring Ping-pong value */
#define	WD95A_S_CMPIX	(62<<ACC_SHIFT)	/* Data Compare Index */
#define	WD95A_S_CMPVAL	(64<<ACC_SHIFT)	/* Data Compare Value Register */
#define	WD95A_S_CMPMASK	(66<<ACC_SHIFT)	/* Data Compare Mask Register */

#define	WD95A_S_BBDL	(68<<ACC_SHIFT)	/* Buffered BD[0..7] */
#define	WD95A_S_BBDH	(70<<ACC_SHIFT)	/* Buffered BD[8..15] */

#define	WD95A_S_CVER	(72<<ACC_SHIFT)	/* Chip/Design Version */
#define	WD95A_S_TEST1	(74<<ACC_SHIFT)	/* Factory Test Register */

#define	WD95A_S_OFFSET	(76<<ACC_SHIFT)	/* REQ/ACK offset counter */

/*
 * register definitions - Normal Mode
 */

#define	WD95A_N_CTL	(0<<ACC_SHIFT)	/* Control Register */
#define	WD95A_N_CTLA	(2<<ACC_SHIFT)	/* Control Register, Auxiliary */

#define	WD95A_N_ISR	(4<<ACC_SHIFT)	/* Interrupt Status Register */
#define	WD95A_N_STOPU	(6<<ACC_SHIFT)	/* Unexpected Stop Status Register */
#define	WD95A_N_UEI	(8<<ACC_SHIFT)	/* Unexpected Event Intr Register */
#define	WD95A_N_ISRM	(10<<ACC_SHIFT)	/* ISR Mask Register */
#define	WD95A_N_STOPUM	(12<<ACC_SHIFT)	/* STOPU Mask Register */
#define	WD95A_N_UEIM	(14<<ACC_SHIFT)	/* UEI Mask Register */

#define	WD95A_N_RESPONSE (16<<ACC_SHIFT) /* Automatic Response Control */
#define	WD95A_N_SQINT	(18<<ACC_SHIFT)	/* WCS Sequencer Interrupt Addr */
#define	WD95A_N_SQADR	(20<<ACC_SHIFT)	/* Current addr WCS is executing */

#define	WD95A_N_STC	(22<<ACC_SHIFT)	/* SCSI Transfer Control Register */
#define	WD95A_N_SPW	(24<<ACC_SHIFT)	/* SCSI Pulse Width Control Reg */

#define	WD95A_N_DESTID	(26<<ACC_SHIFT)	/* Destination ID Register */
#define	WD95A_N_SRCID	(28<<ACC_SHIFT)	/* Source ID Register */
#define	WD95A_N_FLAG	(30<<ACC_SHIFT)	/* Flag Register */

#define	WD95A_N_TC_0_7	(32<<ACC_SHIFT)	/* Transfer Count 0..7 */
#define	WD95A_N_TC_8_15	(34<<ACC_SHIFT)	/* Transfer Count 8..15 */
#define	WD95A_N_TC_16_23 (36<<ACC_SHIFT) /* Transfer Count 16..23 */

#define	WD95A_N_DATA	(38<<ACC_SHIFT)	/* Data Access Port */
#define	WD95A_N_SR	(40<<ACC_SHIFT)	/* Status Register */
#define	WD95A_N_FIFOS	(42<<ACC_SHIFT)	/* Fifo Status Register */

#define	WD95A_N_PBR	(44<<ACC_SHIFT)	/* Physical Block Residue */
#define	WD95A_N_BR0	(46<<ACC_SHIFT)	/* Byte Residue */
#define	WD95A_N_BR1	(48<<ACC_SHIFT)	/* Byte Residue */
#define	WD95A_N_PINGR	(50<<ACC_SHIFT)	/* PING Residue */
#define	WD95A_N_LRCR0	(52<<ACC_SHIFT)	/* LRC Residue Register (Low) */
#define	WD95A_N_LRCR1	(54<<ACC_SHIFT)	/* LRC Residue Register (High) */
#define	WD95A_N_ODDR	(56<<ACC_SHIFT)	/* Odd-Byte Reconnect Register */

#define	WD95A_N_DPR	(64<<ACC_SHIFT)	/* address of first DPR */
#define	W95_DPR_R(_reg)	((64 + (_reg << 1))<<ACC_SHIFT)
...
#define	WCS_TARGET	1		/* set up as target */
