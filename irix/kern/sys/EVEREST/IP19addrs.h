 ...
 *
 *				+-------------------------------+
 *				| IP19 PROM text and r/o data   |
 * 0x1fc00000			+-------------------------------+
 *				|				|
 *				|   FREE SPACE (if present)	|
 *				|				|
 * 0x02000000 (32.0M)		+-------------------------------+
...
#define	GDA_ADDR		SBUS_TO_KVU(0x00000400)
#define SYSPARAM_ADDR		SBUS_TO_KVU(0x00001000)
#define EVCFGINFO_ADDR		SBUS_TO_KVU(0x00002000)
#define EVERROR_ADDR		SBUS_TO_KVU(0x00002800)
#define EVERROR_EXT_ADDR		SBUS_TO_KVU(0x00000a00)
#define MPCONF_ADDR		SBUS_TO_KVU(0x00003000)
...
#define IP19PROM_RESTART	SBUS_TO_KVU(0x1fc00008)
#define IP19PROM_RESLAVE	SBUS_TO_KVU(0x1fc00010)
#define IP19PROM_PODMODE	SBUS_TO_KVU(0x1fc00018)
#define IP19PROM_EPCUARTPOD	SBUS_TO_KVU(0x1fc00020)
#define IP19PROM_FLASHLEDS	SBUS_TO_KVU(0x1fc00028)

#define EV_PROM_RESTART		IP19PROM_RESTART
#define EV_PROM_RESLAVE		IP19PROM_RESLAVE
#define EV_PROM_PODMODE		IP19PROM_PODMODE
#define EV_PROM_EPCUARTPOD	IP19PROM_EPCUARTPOD
#define EV_PROM_FLASHLEDS	IP19PROM_FLASHLEDS

/*
 * EVEREST IO4 PROM addresses
 */
#define IP19PROM_STACK		PHYS_TO_K0(0x00980000)
#define IP19PROM_BASE		SBUS_TO_KVU(0x1fc00000)
#define IP19PROM_SIZE		0x20000
