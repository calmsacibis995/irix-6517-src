...
char **argv;
{
    ...
    if (argc != 5) {
       printf("Usage: gain_interest Vendor_ID (Device_ID OR 0) begaddr (endaddr OR 0)\n");
       printf("Example: gain_interest 0x8045 0 0xfffff000040c 0 \n");
       exit(1);
    }
    ...
    ioctl(fd,DVC1394_GAIN_INTEREST, &interest);
