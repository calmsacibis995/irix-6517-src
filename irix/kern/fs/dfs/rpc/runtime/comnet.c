...
static const char *_identString = "$Id: comnet.c,v 65.5 1998/03/23 17:30:25 gwehrman Exp $";
 ...
 * HISTORY
 * $Log: comnet.c,v $
 * Revision 65.5  1998/03/23 17:30:25  gwehrman
 * Source Identification changed to bracket with SGIMIPS && !_KERNEL.
 *
 * Revision 65.4  1998/02/26 19:05:02  lmc
 * Changes for sockets using behaviors.  Prototype and cast changes.
 *
 * Revision 65.3  1998/01/07  17:21:38  jdoak
 * Source Identification changed.
 *  	- to eliminate compiler warnings
 *  	- to bracket with SGIMIPS
 *
 * Revision 65.2  1997/11/06  19:57:38  jdoak
...
#ifdef SGIMIPS
PUBLIC void rpc_server_use_protseq_if (
unsigned_char_p_t       rpc_protseq,
unsigned32              max_calls,
...
#ifdef SGIMIPS
PUBLIC void rpc_network_inq_protseqs (
...
#ifdef SGIMIPS
PUBLIC boolean32 rpc_network_is_protseq_valid (
unsigned_char_p_t       rpc_protseq,
unsigned32              *status)
#else
...
#ifdef SGIMIPS
PUBLIC void rpc_protseq_vector_free (
...
#ifdef SGIMIPS
PUBLIC void rpc_network_maintain_liveness (
rpc_binding_handle_t    binding_h,
unsigned32              *status)
#else
...

{
    ...
    {
#ifdef SGIMIPS
        count = (int)strlen ((char*) endpoint);
#else
...

{
    ...
    *new_vec = NULL;        /* assume the worst */
     ...
     */
#ifdef SGIMIPS
    bv_size = (int)sizeof (rpc_binding_vector_t)    /* sizeof basic struct */
            + (int)sizeof(handle_t) *(new_count - 1);  /* sizeof binding   */
#else
