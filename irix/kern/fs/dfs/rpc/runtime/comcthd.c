...
static const char *_identString = "$Id: comcthd.c,v 65.7 1998/03/23 17:28:06 gwehrman Exp $";
 ...
 * HISTORY
 * $Log: comcthd.c,v $
 * Revision 65.7  1998/03/23 17:28:06  gwehrman
 * Source Identification changed to bracket with SGIMIPS && !_KERNEL.
 *
 * Revision 65.6  1998/03/09 19:28:10  lmc
 * Remove setting of process name because we are an sthread and they
 * don't have process names.
 *
 * Revision 65.4  1998/01/07  17:21:03  jdoak
 * Source Identification changed.
 *  	- to eliminate compiler warnings
 *  	- to bracket with SGIMIPS
 *
 * Revision 65.3  1997/11/06  19:57:04  jdoak
 * Source Identification added.
 *
 * Revision 65.2  1997/10/20  19:16:46  jdoak
...
#endif
{
    ...
    RPC_MEM_ALLOC (p->ctbl, 
                   cthread_elt_p_t,
#ifdef SGIMIPS
                   p->n_threads * (int)(sizeof (cthread_elt_t)),
#else
