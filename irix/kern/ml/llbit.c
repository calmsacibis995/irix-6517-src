...
/*
 *	NOTE : this routine and the lldefs.h header file came from
 *	irix/lib/libc/src/math directory.   Currently being used
 *	by dmedia to resolve some problems with compiler undefines.
 *	"__ll_bit_extract" and "__ll_bit_insert".
 */
