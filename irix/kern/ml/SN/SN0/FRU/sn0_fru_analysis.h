 ...
 *  has been disabled.
 */
#define KF_REASON_FRU_DISABLE			"CPU disabled by FRU"

/* Where to print the fru messages */
#define KF_PRINT_PROMLOG			0x1	/* promlog */
#define KF_PRINT_CONSOLE			0x2	/* console */
#define KF_PRINT_ERRBUF				0x4	/* error buffer */


/* check if a nasid is a valid nasid */
#define is_valid_nasid(_n)	((_n < MAX_NASIDS) &&  \
				 (NASID_TO_COMPACT_NODEID(_n) != CNODEID_NONE))
/*
 * function prototypes
 */
