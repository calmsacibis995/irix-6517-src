...
#ifndef _KERNEL /* Is this even still used? */
#define _KERNEL	1
#include <sys/types.h>
#undef _KERNEL
...
#define FRU_HIP		(0x3c | FRUC_FCIDEV)
...
extern void check_ip21(evbrdinfo_t *, everror_t *, everror_ext_t *, 
		   whatswrong_t *,	evcfginfo_t *);
extern void check_ip25(evbrdinfo_t *, everror_t *, everror_ext_t *, 
		   whatswrong_t *,	evcfginfo_t *);
extern void check_mc3(evbrdinfo_t *, everror_t *,  everror_ext_t *, 
		  whatswrong_t *, evcfginfo_t *);
extern void check_io4(evbrdinfo_t *, everror_t *,  everror_ext_t *, 
		  whatswrong_t *, evcfginfo_t *);
extern char fru_bank_letter(unsigned int leaf, unsigned int bank);
