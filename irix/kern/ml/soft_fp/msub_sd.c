 ...
 * Module: msub_sd.c
 * $Revision: 1.3 $
 * $Date: 1996/05/18 00:36:54 $
 * $Author: sfc $
 * $Source: /proj/irix6.5.7m/isms/irix/kern/ml/soft_fp/RCS/msub_sd.c,v $
 *
 * Revision history:
 *  12-Jun-94 - Original Version
 *
 * Description:	emulation code for msub.s and msub.d instructions
 *
 * ====================================================================
 * ====================================================================
 */
...
uint64_t rrfrac;
	...
	fp_trace3_sd( precision, rs, rt, rr, MSUB_SD );
#endif
