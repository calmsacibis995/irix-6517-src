 ...
 * Module: nmadd_sd.c
 * $Revision: 1.3 $
 * $Date: 1996/05/18 00:37:00 $
 * $Author: sfc $
 * $Source: /proj/irix6.5.7m/isms/irix/kern/ml/soft_fp/RCS/nmadd_sd.c,v $
 *
 * Revision history:
 *  12-Jun-94 - Original Version
 *
 * Description:	emulation code for nmadd.s and nmadd.d instructions
 *
 * ====================================================================
 * ====================================================================
 */
...
uint64_t rrfrac;
	...
	fp_trace3_sd( precision, rs, rt, rr, NMADD_SD );
#endif
