...
size_t
fwrite(const void *ptr1, size_t size, size_t count, FILE *iop)
{
	register size_t nleft;		/* total number of bytes to write */
	...
	size_t leftover = 0;		/* bytes left after last whole size */
