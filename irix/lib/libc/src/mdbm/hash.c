 ...
 */
uint64
_mdbm_hash5(uchar *str, int len)
{
	uint32  val;                    /* current hash value */
	uchar   *str_end = str + len;
 ...
 */
uint64
_mdbm_hash5(uchar *buf, int len)
{
    uint64 val;	/* current hash value */
    int i;
