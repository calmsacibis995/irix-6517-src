#ident	"@(#)libc-port:gen/errlist.awk	1.4"
...
BEGIN	{
		...
		oldfile = "errlst.c"
		catfile = "syserr.str"
		print "#ident\t\"@(#)libc-port:gen/errlist.awk	1.4\"\n" >oldfile
		...
		print "char * const sys_errlist[] = {" >oldfile
...
END	{
		...
		print "int sys_nerr = " hi + 1 ";" >oldfile
	}
