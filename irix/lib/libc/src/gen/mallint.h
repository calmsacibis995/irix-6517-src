...
/**** NOTE : This will not work on 64bit libc's *****/
...
/* we always want at least 8 byte alignment */
#define ALIGN		8
...
#define SETNOTREE(b)	(LEFT(b) = (TREE *)(-1L))
#define ISNOTREE(b)	(LEFT(b) == (TREE *)(-1L))
...
#define GETCORE		_sbrk
#define ERRCORE		((char *)(-1L))
