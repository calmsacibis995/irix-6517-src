...
/* __file__ =============================================== *
 *
 *  Output converter for wchar_t to eucTW
 */
...
define(`OUTPUT_SETVAL',`
	...
	/* eucw1 eucTW 2 bytes CNS plane 1 */
	'OUTPUT_WCTOB_FAIL`
	...
	/* eucw2 eucTW 4 bytes, CNS plane 2 */
	'OUTPUT_WCTOB_FAIL`
        ...
        'OUTPUT_ASSIGN( OUTPUT_PTR_VAR - 3, (((('RETURN_VAR`) >> 14) | 0200) & 0377) )`;
        'OUTPUT_ASSIGN( OUTPUT_PTR_VAR - 4, ( SS2 ) )`;
    } else {
	if ('RETURN_VAR` >= 0240) {
	    goto illegal_recovery;
	}
