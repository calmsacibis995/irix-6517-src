...
define(`GET_VALUE',`
	...
	if ('RETURN_VAR` == SS2) {
	    ...
	    state$1 = (state$1 << 7)| ('RETURN_VAR` & 0177);
	    /* ============ Get next input character. =================	*/
	    ...
	    state$1 = (state$1 << 7) | ('RETURN_VAR` & 0177) | P01;
	    goto cont$1;
	    ...
	    state$1 = (state$1 << 7) | 'RETURN_VAR` & 0177 | P11;
	    goto cont$1;
 	} else {
	    /* single byte */
	    state$1 = 'RETURN_VAR`;
