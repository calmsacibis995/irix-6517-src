#ident "$Header: /proj/irix6.5.7m/isms/irix/lib/libgrio/src/RCS/table128.c,v 1.16 1997/08/07 16:52:31 kanoj Exp $"
...
#define INV_IP7BOARD_DEV_INFO		5000,		131072
#define INV_IP9BOARD_DEV_INFO		5000,		131072
#define INV_IP12BOARD_DEV_INFO		5000,		131072
#define INV_IP17BOARD_DEV_INFO		5000,		131072
#define INV_IP15BOARD_DEV_INFO		5000,		131072
#define INV_IP20BOARD_DEV_INFO		5000,		131072
#define INV_IP19BOARD_DEV_INFO		5000,		131072
#define INV_IP22BOARD_DEV_INFO		5000,		131072
#define INV_IP21BOARD_DEV_INFO		5000,		131072
#define INV_IP25BOARD_DEV_INFO		5000,		131072
#define INV_IP26BOARD_DEV_INFO		5000,		131072
#define INV_IP27BOARD_DEV_INFO		5000,		131072
#define INV_IP28BOARD_DEV_INFO		5000,		131072
#define INV_IP30BOARD_DEV_INFO		5000,		131072
#define INV_IP32BOARD_DEV_INFO		5000,		131072
...
#define	INV_EVIO_DEV_INFO		5000,		131072
#define INV_IO2_REV1_DEV_INFO		5000,		131072
#define INV_IO2_REV2_DEV_INFO		5000,		131072
#define INV_IO3_REV1_DEV_INFO		5000,		131072
#define INV_IO3_REV2_DEV_INFO		5000,		131072
#define INV_IO4_REV1_DEV_INFO		5000,		131072

#define INV_IO4_ADAP_SCSI_DEV_INFO	1000,		131072
#define INV_IO4_ADAP_VMECC_DEV_INFO	1000,		131072
#define INV_IO4_ADAP_EPC_DEV_INFO	1000,		131072
#define INV_IO4_ADAP_SCIP_DEV_INFO	1000,		131072
...
#define INV_SCSICONTROL_DEV_INFO	72,		131072
...
#define INV_JAGUAR_DEV_INFO		72,		131072
#define INV_VSCSIDRIVE_DEV_INFO		0,		0
#define INV_GIO_SCSICONTROL_DEV_INFO	72,		131072
#define INV_SCSIRAID_DEV_INFO		0,		0
#define INV_PCI_SCSICONTROL_DEV_INFO    72,             131072
#define INV_WD93_DEV_INFO		72,		131072
#define INV_WD93A_DEV_INFO		72,		131072
#define INV_WD93B_DEV_INFO		72,		131072
#define INV_WD95A_DEV_INFO		72,		131072
#define INV_SCIP95_DEV_INFO		72,		131072
#define INV_ADP7880_DEV_INFO		72,		131072
#define INV_TEAC_FLOPPY_DEV_INFO	0,		0
#define	INV_QL_REV1_DEV_INFO		112,		131072
#define	INV_QL_REV2_DEV_INFO		112,		131072
#define	INV_QL_REV2_4_DEV_INFO		112,		131072
#define	INV_QL_REV3_DEV_INFO		112,		131072
#define	INV_FCADP_DEV_INFO		112,		131072
#define	INV_QL_REV4_DEV_INFO		112,		131072
#define	INV_QL_DEV_INFO			112,		131072
...
#define	INV_PCI_BRIDGE_DEV_INFO		720,		131072
#define	INV_XBOW_DEV_INFO		3200,		131072
#define INV_HUB_DEV_INFO		2400,		131072
