...
#pragma weak __libc_attr = __libc_attr

const __ctype_t _ctype_dflt = {
    /* ctype */
    {
	0, /*EOF*/
	_C,	_C,	_C,	_C,	_C,	_C,	_C,	_C,
	_C,  _S|_C|_BL,	_S|_C,	_S|_C,	_S|_C,	_S|_C,	_C,	_C,
	_C,	_C,	_C,	_C,	_C,	_C,	_C,	_C,
	_C,	_C,	_C,	_C,	_C,	_C,	_C,	_C,
    _S|_BL|_PR,	_P,	_P,	_P,	_P,	_P,	_P,	_P,
    ...
    /* Note: The cswidth information is referenced from __libc_attr */
...
__attr_t __libc_attr = {
    ...
    1,				/* Indicate if it is an EUC encoding */
};
