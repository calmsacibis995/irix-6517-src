...
#include "testdefines.h"
	...
	/*
        summary: mpintadd
		This test is the same as mpintadd.s, but it requires that it be run on
		4 tasks at once, as opposed to just two.  Below is the comment from
		mpintadd.s
 ...
 |	 ----	if # iterations is 0, go back to countloop
 |			else
...
ENTRY:
	DEBUG_PRINT_ID(0x10101009)
	li	RSYS, SQUANT	# Increase the time quantum.
	li	RPARM, 1000
	syscall
