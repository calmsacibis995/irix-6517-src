#ifndef _IP21PROM_POD_H_ 
#define _IP21PROM_POD_H_

#include "ip21prom.h"	/* for ASMHNDLR_REG */

#if 1
#define data_reg k1
#define addr_reg k0
#define MDEBUG_MSG(name) \
    	li  data_reg, name;       \
    	sd  data_reg, 0(addr_reg);      \
    	daddi	addr_reg, 8

#define MDEBUG_REG(reg)  \
    	sd  reg, 0(addr_reg);     \
    	daddi	addr_reg, 8

#define MDEBUG_CHECKPOINT(n) \
    	li  data_reg, n; \
    	dli addr_reg, 0x9000000001800000; \
    	sd  data_reg, 0(addr_reg)


#define MDEBUG_CHECKPOINT_ADDR(addr, n) \
    	li  data_reg, n; \
    	dli addr_reg, addr; \
    	sd  data_reg, 0(addr_reg)

/* uses a0, a1, t9, ra, ta2, ta3, t8, v0, v1 */
...
#define ERROR_MSG_FPREG(msg, fpreg) \
    ERROR_MSG(msg); \
    DMFC1(a0, fpreg); \
    jal	pod_puthex; \
    nop;  \
...
#define POD_SR	(SR_IMASK & ~(SR_IBIT8|SR_IBIT1|SR_IBIT2)) | SR_FR | SR_CU1 | SR_PAGESIZE

/* Take error interrupts right away */
#define POD_ILE	8

#define POD_SCACHEADDR		0xa800000000000000
#define POD_SCACHE_TESTADDR	0xa800000000400000
...
#define GCACHE_INVALIDATE 73
#define GCACHE_CHECK_TAG_ADDR 74
#define GCACHE_CHECK_TAG_DATA 75
#define GCACHE_CHECK_DATA 76
#define FORCE_SET3_ON 77
#define FORCE_SET3_OFF 78
#define GCACHE_CHECK 79
#define STAG_DUMP_ALL	80
#define DTAG_DUMP_ALL	81
#define GPARITY_R	82
