...
#ifndef _IP21PROM_INTR_H_
#define _IP21PROM_INTR_H_
...
#define SENDINT_SLAVES(_l) \
	store_double_lo((long long *)EV_SENDINT, EVINTR_VECTOR((_l), PGRP_SLAVE));
#define SENDINT_ALL(_l) \
	store_double_lo((long long *)EV_SENDINT, EVINTR_VECTOR((_l), PGRP_ALL));
