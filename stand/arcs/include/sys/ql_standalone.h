...
typedef struct scatter_g
{
    ...
    uint        num_pages;
    data_seg    dseg[REQUEST_QUEUE_DEPTH*CONTINUATION_SEGS];
...
typedef struct
{
    ...
    struct {                  		      /* bits */
/* munged for SGI */
        u_char  Command_DMA_Burst_Enable    :1; /* 7 */
        u_char  Data_DMA_Burst_Enable       :1; /* 6 */
    ...
    u_char  Pad0[12];   /* pad for byte alignment */
...
{
    /*
    ** Linked list pointer of ha structures for interrupt sharing.
    */
    ...
    */
    ...
    vertex_hdl_t	pci_vhdl;	/* temporary hack 06/04/96 */
    ...
    u_int       flags;			/* general flags for this adapter */
    u_short     revision;		/* PCI Revision ID Register */
    u_short     bridge_revnum;	        /* Bridge rev number */
    ...
    */
    ...
    /*
    ** SCSI Host Adapter Registration data structure.
    */
#ifndef _STANDALONE
    edt_t      ql_shareg;
#endif
...
/*
** data dma configurations register definitions
*/

#define DMA_DATA_DIRECTION      0x1
#define BURST_ENABLE            0x2
#define INTERRUPT_ENABLE        0x4
...
#else
#define AFLG_INITIALIZED            0x0001		/* isp initialized */
#define AFLG_SEND_MARKER            0x0002		/* marker needs to be send */
#define AFLG_INTERRUPTS_ENABLED     0x0004		/* interrupts enabled */
#define AFLG_QUIESCE_IN_PROGRESS    0x0008		/* quiesce in progress */
#define AFLG_QUIESCE_COMPLETE       0x0010		/* quiesce completed */
#define AFLG_DRAIN_IO		    0x0020		/* drain I/O */
#define AFLG_MAIL_BOX_DONE	    0x0040		/* mailbox is done */
#define AFLG_MAIL_BOX_WAITING       0x0080		/* waiting mailbox to finish thru interrupt */
#define AFLG_MAIL_BOX_POLLING       0x0100		/* polling for mailbox to finish */
#define AFLG_SHUTDOWN	    	    0x0200		/* shutdown in progress */
#define AFLG_FAST_NARROW    	    0x0400		/* fast and narrow setup */
#define AFLG_BUS_SCAN_IN_PROGRESS   0x0800		/* bus scan in progress */
#define AFLG_IN_INTR                0x1000		/* in interrupt mode */
#define AFLG_DUMPING                0x2000		/* in dumping mode */
#define AFLG_ASYNC_RESPONSE_IN      0x4000		/* async response coming in */
#define AFLG_DOWNLOAD_FIRMWARE      0x8000		/* downloading firmware */
#define AFLG_INITIAL_SRAM_PARITY    0x10000		/* initializing sram parity */
#define AFLG_SRAM_PARITY_ENABLE	    0x20000		/* enable sram parity memory checking */
#endif
...
typedef volatile struct
{
    ...
    ** Since we don't use SXP registers, we won't define them.
    */
...
#define PCR_INTERRUPT_CONTROL_SCSI		0x0004		/* SCSI */
...
#define HCCR_FORCE_PARITY_ERROR     0xE000  /* force sram parity error*/
        ...
        /* Status Defintions */
#define HCCR_SRAM_PARITY_ERROR_DETECTED  0x0400  /* R: parity error detected */
...
#define DATA_DMA_BURST_ENABLE     	1   /* enabled */
#define CMD_DMA_BURST_ENABLE      	1   /* enabled */
...
#define REV_ISP1020	1
#define REV_ISP1040     1 /* note that this is the same as 1020 */
...
#define QL_MUTEX_ENTER(ha) IOLOCK(ha->res_lock,s), \
                           IOLOCK(ha->req_lock,s)

#define QL_MUTEX_EXIT(ha)  IOUNLOCK(ha->res_lock,s), \
                           IOUNLOCK(ha->req_lock,s)
