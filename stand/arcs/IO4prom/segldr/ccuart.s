 ...
 * 
 * Arguments: a0 - address of ccuart to use. Must be 64-bit address.
 * Returns: nothing
 * Uses: a0, a1, at.
 */
...
LEAF(ccuart_init)
	dla	a1, ccuart_base
	sd	a0, 0(a1)
	sd	zero, CMD(a0)		# Clear state by writing 3 zero's
	nop
	sd	zero, CMD(a0)
	nop
	sd	zero, CMD(a0)
	LI	a1, I8251_RESET		# Soft reset
	sd	a1, CMD(a0)
	LI	a1, I8251_ASYNC16X | I8251_NOPAR | I8251_8BITS | I8251_STOPB1
	sd	a1, CMD(a0)
	LI	a1, I8251_TXENB | I8251_RXENB | I8251_RESETERR
	j	ra 
	sd	a1, CMD(a0)		# (BD)
	END(ccuart_init)
