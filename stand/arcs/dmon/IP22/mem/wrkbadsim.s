#ident	"$Id: wrkbadsim.s,v 1.1 1994/07/20 23:51:02 davidl Exp $"
/**************************************************************************
 *									  *
 ...
 *
 * Register Used:
 *	a0 - Failing address, PRINT clobbers this
 *	a1 - XOR data
 *	ra - Clobber on subroutine call
 *	t8 - temporary bank counter
 *	t6 - Saved RA
...
loop:
	...
	li	t1, 2
	sltu	t2, t8, t1		# check if bank 2 or 3 
	beq	t2, zero, 1f		# and branch
...
1:
	...
	lw	t0, (t1)		# 2 and 3
2:
	move	t1, t8			# determine if bank 0/2 or 1/3
	not	t1
	li	t2, 1
	and	t1, t2			# t1= 0 for banks 0/2
...
1:
	...
	li	t3, MEMCFG_DRAM_MASK	# 
	and	t3, t0, t3		# determine the last addr on bank
	addi	t3, 0x100

	/* t3 equals size in megabytes */
	sll	t3, 14
	addu	t1, t3			# add base to size to get last address

	li	t4, 0x1fffffff		# change address to physical addr since
					# reg. data is physical
	and	t4, s6
	sltu	t1, t4, t1		# now check to see if failing addr is
	...
	sll	t3, t8, 2		# pick up table offset
	addu	t0, t3			# t0 = address of simm table
	b	2f
