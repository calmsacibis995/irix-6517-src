#ident	"$Id: nvram_addru.s,v 1.1 1994/07/21 01:15:09 davidl Exp $"
/**************************************************************************
 *									  *
...
LEAF(nvram_addru_test)
	move	t7, ra			# save return address.
	jal	addr_nvram		# convert start byte index to addr
	move	t5, v0			# initialize start byte addresse
	move	a0, a1
	jal	addr_nvram		# convert end byte index into addr
	move	t6, v0
...
addru_err:
	...
	j	t7
END(nvram_addru_test)

	.data

	.globl  nvram_AddrUMsg
nvram_code:	.asciiz "\r\n  Error code = "
nvram_AddrUMsg:	.asciiz "\n\r  Address-Uniqueness Test ..."
