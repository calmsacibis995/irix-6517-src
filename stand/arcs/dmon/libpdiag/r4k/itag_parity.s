#ident	"$Id: itag_parity.s,v 1.1 1994/07/21 01:25:42 davidl Exp $"
/**************************************************************************
 *									  *
...
#include "cache_err.h"
 ...
 ##############################################################################
 #									      #
 #	Instruction cache tag parity test.				      #
 #	A 0 is returned upon success.					      #
 #									      #
 #	Functional Description:						      #
 #									      #
 #	Tests instruction cache parity.					      #
 #									      #
 #	User Information:						      #
 #									      #
...
LEAF(Itag_parity)
	 ...
	 */
	/* The I-cache tag only has a valid bit for cache state.
	 * This bit is bit 7 of the taglo register.
	 */
	li	t0,0xffffff80		# initial pattern
...
1:
	...
	nop
2:
	cache	CACH_PI | C_IST,(a0)	# store pattern to tag
	nop
