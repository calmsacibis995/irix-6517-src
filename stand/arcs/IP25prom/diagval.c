...
static char nomc3_long[]=
	"The IP25 PROM did not recognize any memory boards in the system.";
static char noio4_long[]=
	"The IP25 PROM did not recognize any IO4 boards in the system.";
...
static char bustag_failed[] = 
        "Duplicate Bus tag failed r/w test.";
...
pod_scmsg_t scmsg_map[] = {
    ...
    {EVDIAG_BUSTAG_DATA,	bustag_failed,		(char *)NULL},
    ...
    {EVDIAG_TESTING_DCACHE,	"Dcache test hung", 	(char *)NULL},
    {EVDIAG_TESTING_ICACHE,	"Icache test hung", 	(char *)NULL},
    {EVDIAG_TESTING_SCACHE,	"Scache test hung", 	(char *)NULL},
    {EVDIAG_INITING_CACHES,	"Hung initing I/D cache",(char *)NULL},
    {EVDIAG_INITING_SCACHE,	"Hung initing Scache",	(char *)NULL},
    {EVDIAG_TESTING_CCTAGS,	"CC tag  test hung", 	(char *)NULL},
...
main()
{
    ...
    printf("IP25 PROM Diagnostic Codes and Their Meanings\n\n");
