...
*	File:		ccio.s						*
*									*
*	This file contains the IP25 PROM Utility Library routines for	*
...
LEAF(ccuart_init) 
	...
	sd	a0, CMD(a1)
	li	a0, I8251_ASYNC16X | I8251_NOPAR | I8251_8BITS | I8251_STOPB2
	sd	a0, CMD(a1)
...
2:     
	...
	move	a0, ta2
	move	a0, v0
        daddiu	ta3, 1			# Increment next char. 
