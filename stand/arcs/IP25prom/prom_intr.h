...
#ifndef _IP25PROM_INTR_H_
#define _IP25PROM_INTR_H_
...
#define BOOT_LEVEL	5	/* Intr Level indicating BM has taken over */
...
#define INTR_LEVEL_MASK ((1<<REARB_LEVEL) | (1<<STATUS_LEVEL)  | \
		         (1<<LAUNCH_LEVEL) | (1<<BOOT_LEVEL) | \
			 (1<<POD_LEVEL)  | (1<<MPCONF_INIT_LEVEL) | \
			 (1<<MPCONF_LAUNCH_LEVEL))
...
#ifdef LANGUAGE_C
#define SENDINT_SLAVES(_l) 	SD(EV_SENDINT,EVINTR_VECTOR((_l),PGRP_SLAVE))
#define SENDINT_ALL(_l) 	SD(EV_SENDINT,EVINTR_VECTOR((_l),PGRP_ALL))
