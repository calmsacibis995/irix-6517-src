...
LEAF(epcuart_flush)
	.set	noreorder
	GET_DUARTBASE(v0)
	add	a0, v0			# Add in the channel selector
...
LEAF(epcuart_putc)
	.set	noreorder
	GET_DUARTBASE(v0)
	add	a1, v0			# Add in the channel selector
...
LEAF(epcuart_poll)
	.set	noreorder
	GET_DUARTBASE(v0)
	add	v0, a0			# Add in the channel selector
1:		
	lb	v0, CNTRL(v0)		# Read	
	nop
	j	ra			# Return
...
2:
	dsrl    a0,t5,30		# Shift right 60 bits ($@!&*# assembler
