...
/************************************************************************
 *									*
 *	dang_gr2read.c - dang chip gio bus read utility			*
 *									*
 ************************************************************************/
...
int
dang_gr2read(int argc, char** argv)
{
    ...
    msg_printf(INFO, "\ndang_gr2read - DANG/GIO Gr2 data read utility\n");
    ...
    if (argc != 4) 
    {
	msg_printf(ERR,"dang_gr2read: bad command line format\n");
	msg_printf(VRB,"usage:\n");
	msg_printf(VRB,"\tdang_gr2read slot# adap# gio_address\n");
	return (1);
    }
    ...
    msg_printf(INFO, "dang_gr2read: address 0x%x, got 0x%x\n",
		gio_address, pattern);
