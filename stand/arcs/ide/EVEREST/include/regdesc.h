#ident	"saio/lib/regdesc.c:  $Revision: 1.2 $"
...
#if R4000
struct reg_values cache_values[] = { /* R4000 only */
...
struct reg_values config_ec_vals[] = {
	...
	{ EC_SHIFTIT(CONFIG_EC_DIV3),	" clock: /3" },
...
#define CONFIG_IB_32	0
#define CONFIG_IB_16	1
...
#define CONFIG_DB_32	0
#define CONFIG_DB_16	1
