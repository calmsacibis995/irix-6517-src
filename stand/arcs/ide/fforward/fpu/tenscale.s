...
/* | consent of MIPS.                                               | */
/* ------------------------------------------------------------------ */
/* $Header: /proj/irix6.5.7m/isms/stand/arcs/ide/fforward/fpu/RCS/tenscale.s,v 1.3 1993/11/01 20:06:26 jeffs Exp $ */

#include <regdef.h>

/* t3/t2/t1/t0 = ta1/ta0 * 10^t0, return binary exponent of 10^t0 in v1. */
/* Bashes a3/a2. */
...
12:	lh	v1, _ptenexp(t1)
	...
	sll	t0, 2
#ifdef MIPSEL
	ld	ta0, _pten+28*8(t0)
#else
	lw	ta0, _pten+0+28*8(t0)
	lw	ta1, _pten+4+28*8(t0)
#endif
	jal	_dwmultu
	bltz	t3, 13f
	sll	t3, 1
