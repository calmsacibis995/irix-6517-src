static char rcsid[] = "$Header: /proj/irix6.5.7m/isms/stand/arcs/ide/fforward/mem/RCS/threebit.c,v 1.3 1995/06/09 20:35:02 jeffs Exp $";
...
extern u_int *WriteLoop14(u_int *, u_int *, u_int, u_int, u_int);
