#ident	"IP22diags/mem/private.c:  $Revision: 1.9 $"
...
{
	__psunsigned_t index = (__psunsigned_t)testaddr & 0x7;
...
{
	bool_t passed = TRUE;
	unsigned int expected_cpu_err_stat =
