#ident "$Header: /proj/irix6.5.7m/isms/stand/arcs/ide/fforward/mem/RCS/kh_dw.s,v 1.4 1997/03/14 23:04:45 wmesard Exp $"
...
*		ta0: error code 						*
*									*
*		v0: zero for pass or ta0 for error code			*
************************************************************************/
	.text

	kh_dw:

		subu	sp,8		# reserve stack frame
		.frame	sp,4,ra
 ...
 */
$42:
		la	ta1, onespat		# set expected data
		ld	t1, (ta1)
