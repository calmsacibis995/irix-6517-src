/*
 * gz_errorcodes.c - Godzilla errorcodes
 *
 ...
 * GRAPHICS, INC.
 *
 *	These errorcodes will be used in the ide tests for the godzilla
 *  architecture.
 */
...
_Test_Info CPU_Test_err[] = {
        ...
        { "Heart & Bridge Save Registers",             "HAB102" },
        { "Heart & Bridge Restore Registers",          "HAB103" },
