...
#ident	"IP26/tlb/tlb.h:  $Revision: 1.1 $"

#include "uif.h"
#define PAGESIZE	(1 << TLBHI_VPNSHIFT)
#define NEXTVPN		0x1 << ( (TLBHI_VPNSHIFT) + 7 )
...
extern void		set_tlbpid(machreg_t);
extern long		probe_tlb(char *, unsigned int);

extern void tlbwired(int, int, caddr_t, unsigned int, unsigned int);
extern void tfptlbfill(unsigned long, unsigned long, unsigned long, unsigned long);
