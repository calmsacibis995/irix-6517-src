...
LEAF(pon_mc)
	...
	/* Test the data path to TCC by walking a 1 through TCC_COMPARE
	 * (we cannot do all 64 bits this way unfortunately).
	 */
	LI	T34,PHYS_TO_K1(TCC_COMPARE)
	lui	a1,0x400		# set-up bit 31 w/o sign extension
	sll	a1,1
...
1:
	...
	srl	a1,1			# walk bit
	bne	a1,zero,1b		# loop till bit 0 done
