...
__uint32_t i,cfifo_val, cfifo_status, height, scanWidth, cmd;
	...
	height = 0x20;
	scanWidth = 0x200;
	_send_data(height, scanWidth, TEX_MDDMA_TEST);
	...
	hq_HQ_RE_WrReg_2(0x102,0x5555,0x00000005);
        ...
        height = 0x20;
        scanWidth = 0x200;
        _send_data(height, scanWidth, TEX_MDDMA_TEST | 0x100);
...
hq_HQ_RE_WrReg_2(0x102,0x5555,0x00000005);
        ...
        height = 0x20;
        scanWidth = 0x200;
        _send_data(height, scanWidth, TEX_MDDMA_TEST | 0x200);
...
hq_HQ_RE_WrReg_2(0x102,0x5555,0x00000005);
        ...
        height = 0x20;
        scanWidth = 0x200;
        _send_data(height, scanWidth, TEX_MDDMA_TEST | 0x300);
...
hq_HQ_RE_WrReg_2(0x268,0x00000000,0x00001000);
hq_HQ_RE_WrReg_0(0x18a,0x00000000,0x00000d55);
...
hq_HQ_RE_WrReg_0(0x1a1,0x00000000,0x00004024);
hq_HQ_RE_WrReg_0(0x159,0x00000000,0x00400070);
...
if (numRE4s == 2) {
   ...
   for (i = 0; i < 2; i++) {
	...
	/* use file MGRAS_mddma_array_4 */
        height = 0x100; 
        scanWidth = 0x300;
        _send_data(height, scanWidth, TEX_MDDMA_TEST | 0x400 | (i << 12));
	...
	/* use file MGRAS_mddma_array_4 */
        height = 0x100; 
        scanWidth = 0x300;
        _send_data(height, scanWidth, TEX_MDDMA_TEST | 0x400 );
