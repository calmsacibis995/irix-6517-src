static char rcsid[] = "$Header: /proj/irix6.5.7m/isms/stand/arcs/ide/IP32/mem/RCS/new3bit.c,v 1.2 1997/05/15 16:08:50 philw Exp $";
...
static int threebit();
static int dwd_3bit();
three_ll(u_int first, u_int last, struct tstvar *tstparms )
{
	u_int i;
	u_int j;
