...
LEAF(pon_mc)
	...
	CLI	T31,PHYS_TO_COMPATK1(CPUCTRL0)
	lw	T32,0(T31)
	 ...
	 */
	CLI	T34,PHYS_TO_COMPATK1(CPU_MEMACC)
...
1:
	 ...
	 */
	CLI	T34,PHYS_TO_COMPATK1(HPC3_ETHER_RX_NBDP)
	li	a1,1<<31
2:
	sw	a1,0(T34)
	lw	a2,0(T34)
	...
	CLI	T34,PHYS_TO_COMPATK1(HPC3_ETHER_RX_CBP)
	li	a1,1<<31
2:
	sw	a1,0(T34)
	lw	a2,0(T34)
