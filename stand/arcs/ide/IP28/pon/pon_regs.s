...
LEAF(pon_regs)
	 ...
	 * status register 
	 */
	CLI	T21,PHYS_TO_COMPATK1(WD_SCSI_ADDR0)
	CLI	T23,PHYS_TO_COMPATK1(WD_SCSI_ADDR1)
...
1:	
	 ...
	 * generated
	 */
	CLI	T20,PHYS_TO_COMPATK1(SEEQ_ENET_TX_ADDR)	# read tx status reg
	lbu	T21,0(T20)
	CLI	T20,PHYS_TO_COMPATK1(SEEQ_ENET_RX_ADDR)	# write rx control reg
	li	T21,BYTE1
	sb	T21,0(T20)

	/* test RTC path - write and readback values to two registers
	 */
	LI	T20,RTC_NVRAM_ADDR		# write rtc nvram
...
2: 	sb	T23,0(T20)			# restore rtc data
	 ...
	 */
	CLI	T20,PHYS_TO_COMPATK1(HPC3_INT2_ADDR)	# use INT2
