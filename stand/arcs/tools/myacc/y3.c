...
#ident        "$Header: /proj/irix6.5.7m/isms/stand/arcs/tools/myacc/RCS/y3.c,v 1.1 1996/03/17 02:05:37 csm Exp $"
# include "dextern"
...
void output()
{
	...
	(void) fprintf( ftable, "%syytabelem %syyexca[] ={\n", modpref, modpref );
	...
	(void) fprintf( ftable, "# define %sYYNPROD %d\n", modpref, nprod);
}
