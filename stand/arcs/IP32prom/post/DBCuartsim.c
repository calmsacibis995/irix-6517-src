 ...
 * -------------------------------------------------------------
 *  $Revision: 1.1 $
 *  $Date: 1997/08/18 20:48:10 $
 * -------------------------------------------------------------
 *  routines to initialize the simulated Debugcard UART port.
 */
 ...
 *
 * $Log: DBCuartsim.c,v $
 * Revision 1.1  1997/08/18 20:48:10  philw
 * updated file from bonsai/patch2039 tree
 *
 * Revision 1.2  1996/10/21  08:33:53  kuang
 * Added global simulation CPP checking
 *
 * Revision 1.1  1995/11/20  23:07:09  kuang
 * initial checkin
 *
 * -------------------------------------------------------------
 */
