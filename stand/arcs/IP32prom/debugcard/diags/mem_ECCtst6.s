 ...
 */
    ...
    la      a1, walk1_table         /* load the data table address.     */
    lui     a2, 0x8000              /* create the last data.            */
    dsll32  a2, a2, 0               /* move to right place.             */
...
4:  la      a0, TESTADDR            /* load the test address again      */
    ...
    la      a1, walk1_table         /* and the data address.            */
...
1:  lwu     t5, 0x0(a1)             /* and data from data table.        */
    ...
    beq	    s1, t5, 2f              /* Is it what we expected ??        */
    addiu   a1, a1, 0x10            /* point to next data.              */
    bal	    err			    /* Its not what we expected.        */
    nop	                            /* branch delay slot.               */
2:  bne	    t2, a2, 1b		    /* is this the last data ??         */
    nop	                            /* branch delay slot.               */
...
/*
 * ===================================================
 * $Date: 1997/08/18 20:40:36 $
 * $Revision: 1.1 $
 * $Author: philw $
 * ===================================================
#
# $Log: mem_ECCtst6.s,v $
# Revision 1.1  1997/08/18 20:40:36  philw
# updated file from bonsai/patch2039 tree
#
# Revision 1.3  1996/10/31  21:50:38  kuang
# Bring Bonsai IP32 debugcard up to the level of IP32 debugcard v2.4 on Pulpwood
#
# Revision 1.3  1996/10/04  20:33:05  kuang
# Ported to run with crime ECC
#
# Revision 1.2  1996/04/12  02:15:31  kuang
# Now ECC tests run with R4600/DebugCard environment
#
# Revision 1.1  1996/04/04  23:50:05  kuang
# Ported from petty_crime design verification test suite
#
# Revision 1.3  1995/06/14  21:36:10  kuang
# initial check in, test passed VHDL simulation.
#
# Revision 1.6  1995/06/09  22:17:06  kuang
# The first working version.
#
# Revision 1.5  1995/05/19  23:18:50  kuang
# Added 30 nops between the write data and the ecc register read.
#
# Revision 1.4  1995/05/19  21:32:35  kuang
# *** empty log message ***
#
# Revision 1.3  1995/05/19  01:58:52  kuang
# *** empty log message ***
#
# Revision 1.2  1995/05/19  00:32:28  kuang
# *** empty log message ***
#
# Revision 1.1  1995/05/13  00:52:43  kuang
# Initial revision
#
# Revision 1.1  1995/04/20  23:31:45  kuang
# Initial revision
#
#
 */
