/*
 * ===================================================
 * $Date: 1997/08/18 20:40:22 $
 * $Revision: 1.1 $
 * $Author: philw $
 * ===================================================
 *  test name:      mem_ECCtst13.c
...
mem_ECCtst13 (void)
{
    ...
    BlockErr (TESTADDR, 0xe, 1)  ;  /* write to memory (block write). 	*/
    memptr->status = 0x0         ;  /* Now disable ecc checking.        */

    /*
     *	[03] a word read, nothing should happened - no interrupt/trap.
     */
    ...
    *(uint32_t *)((kseg1|TESTADDR)) = 0xdeadbeef ; /* read/modify/write	*/
    for (i = 0xffff ; i > 0x0 ; i--);   /* let's wait for the interrupt.*/
 ...
 * =================================================
 *
 * $Log: mem_ECCtst13.c,v $
 * Revision 1.1  1997/08/18 20:40:22  philw
 * updated file from bonsai/patch2039 tree
 *
 * Revision 1.2  1996/10/31  21:50:28  kuang
 * Bring Bonsai IP32 debugcard up to the level of IP32 debugcard v2.4 on Pulpwood
 *
 * Revision 1.2  1996/10/04  20:32:46  kuang
 * Ported to run with crime ECC
 *
 * Revision 1.1  1996/04/04  23:49:56  kuang
 * Ported from petty_crime design verification test suite
 *
 * Revision 1.1  1995/06/30  16:36:31  kuang
 * Initial revision
 *
 * Revision 1.1  1995/06/30  16:32:38  kuang
 * Initial revision
 *
