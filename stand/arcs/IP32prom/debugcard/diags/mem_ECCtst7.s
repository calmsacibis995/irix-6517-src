/*
 *  test name:      mem_ECCtst7.s
 *  descriptions:   ecc Walking 1 pattern test.
 */
 ...
 */
    ...
    la      a1, walk0_table         /* load the data table address.     */
    lui     a2, 0x8000              /* create the last data.            */
    dsll32  a2, a2, 0               /* move to right place.             */
    not     a2                      /* the true last data.              */
...
4:  la      a0, TESTADDR            /* load the test address again      */
    ...
    la      a1, walk0_table         /* and the data address.            */
...
/*
 * ===================================================
 * $Date: 1997/08/18 20:40:38 $
 * $Revision: 1.1 $
 * $Author: philw $
 * ===================================================
#
# $Log: mem_ECCtst7.s,v $
# Revision 1.1  1997/08/18 20:40:38  philw
# updated file from bonsai/patch2039 tree
#
# Revision 1.3  1996/10/31  21:50:40  kuang
# Bring Bonsai IP32 debugcard up to the level of IP32 debugcard v2.4 on Pulpwood
#
# Revision 1.3  1996/10/04  20:33:08  kuang
# Ported to run with crime ECC
#
# Revision 1.2  1996/04/12  02:15:32  kuang
# Now ECC tests run with R4600/DebugCard environment
#
# Revision 1.1  1996/04/04  23:50:06  kuang
# Ported from petty_crime design verification test suite
#
# Revision 1.1  1995/06/14  21:36:20  kuang
# Initial revision
#
# Revision 1.2  1995/06/09  22:17:21  kuang
