...
*/
    printf("build input dma descriptors\n");
    BuildDescriptors(output_descriptors, tunetab,NSAMPS*sizeof(long)*2);
/*
...
*/
    ...
    for(i=0;i<NSAMPS*2;i++)soundbuf[i]=0;
...
SetupHAL2(void)
{
    ...
    *idr1p = (6<<7)	/* Left D/A output atten */
	    +(6<<2)    /* Right D/A output atten */
