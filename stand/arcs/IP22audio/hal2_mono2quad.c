...
int sintab[48000];
int tunetab[NSAMPS*1];	/* the *1 is because it's quad */
...
SetupHAL2(void)
{
    ...
    *isrp = HAL2_ISR_CODEC_RESET_N|HAL2_ISR_GLOBAL_RESET_N;
    /* silly chip has to be brought out of reset before CODEC_MODE is toggled */    us_delay(50);
    ...
    *idr0p = 0x18;  /* Enable DAC A and codec B*/
    *iarp = HAL2_DMA_ENABLE_W;
    SPIN;
}
