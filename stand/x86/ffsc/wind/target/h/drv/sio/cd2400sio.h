...
01a,06mar95,myz  written (from cd2400Serial.h).
*/

/*
*/

#ifndef __INCcd2400Sioh
#define __INCcd2400Sioh
...
typedef struct
    ...
    BOOL        created;
    UINT16      int_vec;        /* channel interrupt vector base */
    UINT16      chan_num;       /* the channel number of this device */
    UINT16      channelMode;
    void        (*intEnDisable)(int mode);
    struct CD2400_QUSART * pQusart;
    } CD2400_CHAN;

/* cd2400 chip descriptor */

typedef struct CD2400_QUSART
    {
    CD2400_CHAN  channel[N_CHANNELS];
    UINT16      numChannels;
    char *	baseAdrs;		/* the base address of the device */
    UINT16      regSpacing;
    INT16       devMode;		/* only one channel in polling mode */
    int		baudClkFreq;
    BOOL	(*rxReady) (struct CD2400_QUSART *);
    BOOL	(*txReady) (struct CD2400_QUSART *);
    } CD2400_QUSART;
