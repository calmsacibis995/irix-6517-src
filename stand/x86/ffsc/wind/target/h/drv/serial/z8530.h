/* z8530.h - Zilog 8530 Serial Communications Controller header file */
...
01i,27aug92,ccc  changed NEW_TY_CO_DRV to OLD_TY_CO_DRV.
01h,05jun92,ccc  added typedef structure.
01g,26may92,rrr  the tree shuffle
01f,04oct91,rrr  passed through the ansification filter
		  -changed copyright notice
01e,05oct90,shl  added copyright notice.
                 made #endif ANSI style.
01d,12mar90,dab  fixed definition of SCC_WR1_PARITY (was 0x40, should be 0x04).
...
#ifndef	OLD_TY_CO_DRV
typedef struct		/* TY_CO_DEV */
    {
    TY_DEV tyDev;
    BOOL   created;		/* true if device has already been created */
    volatile char  *cr;		/* control register I/O address */
    volatile char  *dr;		/* data port I/O address */
    volatile char   intVec;	/* interrupt vector address */
    int    baudFreq;		/* baud clock frequency */
    char   numChannels;		/* number of channels to support */
    char   intType;		/* type of vector to supply from 8530 */
    char   clockModeWR11; 	/* write register 11 value to write */
    char   clockModeWR14; 	/* write register 14 value to write */
    } TY_CO_DEV;
#endif	/* OLD_TY_CO_DRV */
...
IMPORT	void	tyCoIntWr (int channel);
IMPORT	void	tyCoIntRd (int channel);
IMPORT	void	tyCoIntEx (int channel);
IMPORT	void	tyCoInt (int channel);

#else

IMPORT	void	tyCoIntWr ();
IMPORT	void	tyCoIntRd ();
IMPORT	void	tyCoIntEx ();
IMPORT	void	tyCoInt ();
