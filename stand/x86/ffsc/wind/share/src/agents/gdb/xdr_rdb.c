...
--------------------
01c,10mar93,maf  changed #include <> to #include "" for consistency.
01b,06sep92,maf  removed include of "vxWorks.h."
01a,09jan91,maf  created using v1a of xdr_rdb.c for 4.0.2 VxWorks 68k.
		 added xdr_SOURCE_STEP.
*/
