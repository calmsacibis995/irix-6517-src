...
01d,26aug93,hdn  added macros for I80X86.
...
#define MIPS64_GREG_SIZE	0x08	/* size of general-purpose reg */
#define MIPS64_GREG_PLEN	0x120	/* size of general-purpose reg block */

/* offsets into general-purpose register block */

#define MIPS64_R_GP0		0x00	/* gp0 (zero) */
#define MIPS64_R_AT		0x08	/* at */
#define MIPS64_R_V0		0x10	/* v0 */
#define MIPS64_R_V1		0x18	/* v1 */
#define MIPS64_R_A0		0x20	/* a0 */
#define MIPS64_R_A1		0x28	/* a1 */
#define MIPS64_R_A2		0x30	/* a2 */
#define MIPS64_R_A3		0x38	/* a3 */
#define MIPS64_R_T0		0x40	/* t0 */
#define MIPS64_R_T1		0x48	/* t1 */
#define MIPS64_R_T2		0x50	/* t2 */
#define MIPS64_R_T3		0x58	/* t3 */
#define MIPS64_R_T4		0x60	/* t4 */
#define MIPS64_R_T5		0x68	/* t5 */
#define MIPS64_R_T6		0x70	/* t6 */
#define MIPS64_R_T7		0x78	/* t7 */
#define MIPS64_R_S0		0x80	/* s0 */
#define MIPS64_R_S1		0x88	/* s1 */
#define MIPS64_R_S2		0x90	/* s2 */
#define MIPS64_R_S3		0x98	/* s3 */
#define MIPS64_R_S4		0xa0	/* s4 */
#define MIPS64_R_S5		0xa8	/* s5 */
#define MIPS64_R_S6		0xb0	/* s6 */
#define MIPS64_R_S7		0xb8	/* s7 */
#define MIPS64_R_T8		0xc0	/* t8 */
#define MIPS64_R_T9		0xc8	/* t9 */
#define MIPS64_R_K0		0xd0	/* k0 */
#define MIPS64_R_K1		0xd8	/* k1 */
#define MIPS64_R_GP		0xe0	/* gp */
#define MIPS64_R_SP		0xe8	/* sp */
#define MIPS64_R_S8		0xf0	/* s8 */
#define MIPS64_R_RA		0xf8	/* ra */
#define MIPS64_R_LO		0x100	/* lo */
#define MIPS64_R_HI		0x108	/* hi */
#define MIPS64_R_SR		0x110	/* sr */
#define MIPS64_R_PC		0x118	/* pc */
	
#define MIPS64_FPREG_SIZE	0x04	/* size of floating-point data reg */
#define MIPS64_FPREG_PLEN	0x84	/* size of floating-point reg block */

/* offsets into floating-point register block */

#define MIPS64_R_FP0		0x00	/* f0; f1 - f31 follow in sequence */
#define MIPS64_R_FPCSR		0x80 	/* offset of fpcsr in reg block */
...
/* General registers for the I80X86 */

#define I86_GREG_SIZE           0x04
#define I86_GREG_PLEN           0x28

#define I86_R_EAX               0x00
#define I86_R_SR                0x20
#define I86_R_PC                0x24

/* Floating point registers for the I80X86 */

#define I86_FPREG_SIZE          0x0a
#define I86_FPREG_PLEN          0x5c

#define I86_R_FP0               0x00
#define I86_R_FPCR              0x50
#define I86_R_FPSR              0x54
#define I86_R_FPTAG             0x58
