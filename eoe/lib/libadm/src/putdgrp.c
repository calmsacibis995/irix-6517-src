...
static	int			lkdgrptab(char *, int);
static	int			unlkdgrptab(void);
static	struct dgrptabent      *mkdgrptabent(char *, char **);
static	FILE		       *opennewdgrptab(char **);
static	int			mknewdgrptab(char *);
static	int			rmnewdgrptab(char *);

/*
...
static int
lkdgrptab(char *o_mode, int lktype)
...
mkdgrptabent(char *dgroup, char **members)
...
int
_putdgrptabrec(FILE *stream, struct dgrptabent *rec)
...
int
_adddgrptabrec(char *dgrp, char **members)
...
int
_rmdgrpmems(char *dgrp, char **mems, char ***notfounds)
