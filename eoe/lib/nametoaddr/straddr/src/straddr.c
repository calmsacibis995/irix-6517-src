...
#ident	"@(#)nametoaddr:straddr/straddr.c	1.8.2.1"
...
static char ** searchhost( FILE *fp, char *token, int *nelements, int field);
static char * searchserv( FILE  *fp, char  *token, int   field);
