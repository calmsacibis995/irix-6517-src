...
#ident	"@(#)librpc:auth_des.c	1.5.3.1"
 ...
 */
#if defined(__STDC__) 
        #pragma weak authdes_seccreate	= _authdes_seccreate
#endif
...
static bool_t synchronize( char *, struct timeval *);
static void msgout( const char *);
	...
	struct timeval *timep)
{
	...
	if (! rpcb_gettime(timehost, &timep->tv_sec )) {
