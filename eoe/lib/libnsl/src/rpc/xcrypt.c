...
#ident	"@(#)libnsl:rpc/xcrypt.c	1.1.1.1"
...
#if defined(__STDC__) 
#ifndef _LIBNSL_ABI
        #pragma weak xencrypt	= _xencrypt
        #pragma weak xdecrypt	= _xdecrypt
        #pragma weak passwd2des	= _passwd2des
#endif /* _LIBNSL_ABI */
#endif
...
static hex2bin( int len, char *hexnum, char *binnum);
static bin2hex( int len, unsigned char *binnum, char *hexnum);
