	...
	SVCXPRT *xprt;
{
	...
	if (xports == NULL) {
		 ...
		 */
/*
 * This is commented out because batched rpc does not seem to work,
 * and lock manager dumps core.
