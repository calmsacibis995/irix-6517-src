 ...
 */
#if defined(__STDC__) 
        #pragma weak svc_dg_create	= _svc_dg_create
#ifndef _LIBNSL_ABI
        #pragma weak svc_dg_enablecache	= _svc_dg_enablecache
#endif /* _LIBNSL_ABI */
#endif
...
static void
svc_dg_destroy(register SVCXPRT *xprt)
{
	register struct svc_dg_data *su = su_data(xprt);
