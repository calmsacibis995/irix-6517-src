...
#ident	"@(#)librpc:netnamer.c	1.3.4.1"
...
*/ 
/*
 * netname utility routines convert from unix names (uid, gid) to network
 * wide names and vice-versa.
...
#ifndef _LIBNSL_ABI
        #pragma weak getnetid		= _getnetid
#endif /* _LIBNSL_ABI */
#endif
