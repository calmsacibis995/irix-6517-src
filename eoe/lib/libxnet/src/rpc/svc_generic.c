...
#ident	"@(#)librpc:svc_generic.c	1.7.6.1"
 ...
 */
#if defined(__STDC__) 
        #pragma weak svc_create		= _svc_create
        #pragma weak svc_tli_create	= _svc_tli_create
        #pragma weak svc_tp_create	= _svc_tp_create
#endif
