...
#ident	"@(#)librpc:xdr_float.c	1.5.4.1"
...
#endif
{
	...
	case XDR_ENCODE:
#if defined(mc68000) || defined(sparc) || defined(u3b2) || defined(u3b15) || defined(i386) || defined(sgi)
...
#endif
{
	...
	case XDR_ENCODE:
#if defined(mc68000) || defined(sparc) || defined(u3b2) || defined(u3b15) || defined(sgi)
		lp = (long *)dp;
