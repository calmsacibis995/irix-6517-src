...
#ident	"@(#)librpc:clnt_raw.c	1.3.3.1"
 ...
 */
#if defined(__STDC__) 
        #pragma weak clnt_raw_create	= _clnt_raw_create
#endif
...
/*ARGSUSED*/
static void
clnt_raw_geterr(CLIENT *a, struct rpc_err *b)
{
}
...
/*ARGSUSED*/
static void
clnt_raw_abort(CLIENT *a)
{
}

/*ARGSUSED*/
static bool_t
clnt_raw_control(CLIENT *a, int b, void *c)
{
	return (FALSE);
}
