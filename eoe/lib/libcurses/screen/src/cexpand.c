...
*/
char *
rmpadding (register char *str, register char *padbuffer, int *padding)
{
...
char *cexpand (register char *str)
{
    char padbuffer[512];
    char *retptr;
...
/*
    ...
    termcap printables.
*/
int cpr (register FILE *stream, register char *string)
{
    register char *ret;
    if (string != NULL)
	{
