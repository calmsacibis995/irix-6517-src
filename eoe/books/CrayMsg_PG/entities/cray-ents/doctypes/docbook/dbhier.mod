...
<!-- Cray modification: (DRD 9-24-97) refer to the marked section for
     set.content.module for workaround to EBT mkbook problem.  -->

<!-- Cray modification: (DRD 11-11-97) changed content model of
...
<!ENTITY % rdbhier2	PUBLIC	"-//Cray Research, Inc.//ELEMENTS DocBook Document Hierarchy Redeclarations Number 2//EN">
%rdbhier2;
...
<!-- Cray modification: (DRD 9-24-97) removed marked section start for
     set.content.module here to make EBT mkbook parser work 
     If ever need to ignore or include, set both set.module 
     and setinfo.module instead of just set.content.module -->
...
<!-- end of Cray modification: (DRD 9-24-97) marked section end 
     for set.content.module should go here -->
...
<!ELEMENT Preface - O ((%bookcomponent.title.content;), 
		(%bookcomponent.content;)) -(IndexTerm) +(%ubiq.mix;) >
<!ATTLIST Preface
		%common.attrib;
