<!-- 	Silicon Graphics, Inc.
	Cray DocBook DTD text stylesheet
	Software Publications
	March 5, 1998 (Production Version 3.4)
...
<style name="PUBNUMBER" group="H1.TEXT-BEFORE">
	<space-before>	12	</>
	<space-after>	&float.space-after	</>
	<text-before>Cray Research Publication Number: </>
</style>
...
<style name="COMMAND">
	<font-family>	Courier	</>
	<text-after>if(attr(sectionref),if(eq(attr(sectionref),blank),,\(gamut(attr(sectionref), '1 1B 1B-U 1M 1M-U 1X 1X-U 2 3 3C 3C-U 3F 3F-U 3G
3G-U 3I 3I-U 3K 3K-U 3L 3L-U 3M 3M-U 3N 3N-U 3O 3O-U 3R 3R-U 3S 3S-U 3X 3X-U 4 4P 4P-U 5 5X 5X-U 6 7 7D 7D-U 7X 7X-U 8 8E 8E-U','1 1B 1B 1M 1M 1X 1X 2 3 3C 3C 3F 3F 3G 3G 3I 3I 3K 3K 3L 3L 3M 3M 3N 3N 3O 3O 3R 3R 3S 3S 3X 3X 4 4P 4P 5 5X 5X 6 7 7D 7D 7X 7X 8 8E 8E', join('??'))\)),)</>
</style>
...
<style name="LEGALNOTICE">
	<space-before>	&float-value	</>
	<space-after>	mult(float-value,1.5)	</>
	<hrule>	After	</>
</style>
...
<style name="LISTITEM,PARA">
	<left-indent>	if(ancestor(deflistentry,me(),1),,+=15)	</>
	<space-after>	&float.space-after	</>
...
<style name="NEWLINE">
	<break-after>	if(isempty(content(ancestor(*,me(),1))),,true)	</>
</style>
...
<style name="SYNOPSIS">
	<font-family>	Courier	</>
	<space-before>	if(eq(attr(format),yes),float.space-before,float.space-before,)	</>
	<space-after>	if(eq(attr(format),yes),float.space-after,float.space-after,)	</>
