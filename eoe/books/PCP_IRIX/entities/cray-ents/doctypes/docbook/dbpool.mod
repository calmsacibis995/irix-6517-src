...
<!-- Redeclaration placeholder for element classes and mixtures........... -->
<![ %dbclass.redecl.module;	[
<!ENTITY % rdbclass PUBLIC "-//Cray Research, Inc.//ELEMENTS DocBook Class and Element Redeclarations//EN">
%rdbclass;
<!-- end of dbclass.redecl.module -->]]>
...
<!ENTITY % rdbpool PUBLIC "-//Davenport//ELEMENTS DocBook Information Pool Redeclarations//EN">
%rdbpool;
...
<!ELEMENT Comment - - ((%para.char.mix;)+) -(Comment|%ubiq.mix;)>
<!ATTLIST Comment
		%common.attrib;
...
<!-- DRD Cray change here for different use of role attribute -->
<![ %admon.module; [
<!ENTITY % local.admon.attrib "">
<!ELEMENT (%admon.class;) - - (Title?, (%admon.mix;)+) -(%admon.class;)>
<!ATTLIST (%admon.class;)
		-- %common.attrib; replaced here with components --
		%id.attrib;
		%lang.attrib;
		%remap.attrib;
		-- %role.attrib; commented out because of local version --
		Role (ansi-iso|openmp) #IMPLIED
		%xreflabel.attrib;
		%revisionflag.attrib;
		%effectivity.attrib;
		%local.common.attrib;
