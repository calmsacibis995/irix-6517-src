 ...
 * Initial revision
 *
 * Revision 1.1.2.3  1993/01/03  21:37:51  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/03  14:32:19  bbelch]
 *
 * Revision 1.1.2.2  1992/12/23  18:42:59  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/23  00:59:19  zeliff]
 * 
 * Revision 1.1  1992/01/19  03:00:36  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
#endif
{
    ...
    if (if_n_p->xa_types != NULL) {
        printf("\nTransmit-as types list:\n");
        AST_dump_simple_types_list (if_n_p->xa_types, 1);
    };
    ...
    if (if_n_p->ch_types != NULL) {
        printf("\nContext_handle types list:\n");
        AST_dump_simple_types_list (if_n_p->ch_types, 1);
    };
