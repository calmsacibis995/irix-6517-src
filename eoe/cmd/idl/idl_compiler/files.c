 ...
 * 	*** empty log message ***
 * 
 * Revision 1.1.1.2  1992/05/05  13:41:47  harrow
...

{
    ...
    /* 
     *  Setup the related or file type global FILE_def_filespec such any file
     *  lookup is handled appropriately in FILE_parse.
     */
    if (rel_filespec)
