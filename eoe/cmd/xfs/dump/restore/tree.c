#ident "$Header: /proj/irix6.5.7m/isms/eoe/cmd/xfs/dump/restore/RCS/tree.c,v 1.20 1999/08/03 15:53:30 cwf Exp $"
...
static nh_t Node_alloc( ino64_t ino,
			gen_t gen,
			nrh_t nrh,
			dah_t dah,
			size_t flags );
...
static nh_t link_hardh( ino64_t ino, gen_t gen );
...
static nh_t hash_find( ino64_t ino, gen_t gen );
...
static bool_t tsi_walkpath( char *arg, nh_t rooth, nh_t cwdh,
			    ...
			    ino64_t *inop, bool_t *isdirprp, bool_t *isselpr );
...
{
	nh_t hardh;
	ino64_t ino = fhdrp->fh_stat.bs_ino;
...
void
tree_addent( nh_t parh, ino64_t ino, size_t g, char *name, size_t namelen )
{
...
tsi_walkpath( char *arg, nh_t rooth, nh_t cwdh,
	      dlog_pcbp_t pcb, void *pctxp,
	      nh_t *namedhp, nh_t *parhp, nh_t *cldhp,
	      ino64_t *inop, bool_t *isdirprp, bool_t *isselprp )
{
	nh_t namedh;
	nh_t parh;
	nh_t cldh;
...
static nh_t
Node_alloc( ino64_t ino, gen_t gen, nrh_t nrh, dah_t dah, size_t flags )
{
	nh_t nh;
	node_t *np;
 ...
 */
static nh_t
link_hardh( ino64_t ino, gen_t gen )
{
...
static nh_t
hash_find( ino64_t ino, gen_t gen )
{
	nh_t nh;
	node_t *np;
	size_t hix;
