#if 0
static char sccsid[] = 	"@(#)rpc_clntout.c	1.3 90/07/25 4.1NFSSRC Copyr 1990 Sun Micro";
#endif
	...
	proc_list *proc;
{
	...
	f_print(fout,
#ifdef sgi
		"\tif (clnt_call(clnt, %s, (xdrproc_t)xdr_%s, argp, (xdrproc_t)xdr_%s, %sres, TIMEOUT) != RPC_SUCCESS) {\n",
#else
