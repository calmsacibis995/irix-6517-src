/*       @(#)automount.h	1.3 90/07/24 4.1NFSSRC SMI   */
 ...
 */
enum	nfs_level	{NFS2 = 0, NFS3 = 1, NFS2_OVERRIDE = 2};
struct mapent {
	char	*map_root;
	char	*map_mntpnt;
	char	*map_mntopts;
	...
	short	map_exflags;
	enum nfs_level	map_nfs_level;		/* nfs = 0, nfs3 = 1 */
};
...
int ping_cache_time;	/* seconds to believe ping results */
