#ifndef lint
static char sccsid[] = 	"@(#)auto_look.c	1.4 90/07/24 4.1NFSSRC Copyr 1990 Sun Micro";
#endif
	...
	char *mapopts, *host;
{
	...
	/* First try to use the SGI protocol to get our mount options,
	 * to see "nohide" filesystems.
	 */
	if (!(clnt_stat = callrpc(host, MOUNTPROG_SGI, MOUNTVERS_SGI_ORIG,
				  MOUNTPROC_EXPORTLIST,
				  xdr_void, 0, xdr_exportlist, &el))) {
