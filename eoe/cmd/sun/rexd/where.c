/* @(#)where.c	1.2 87/08/13 3.2/4.3NFSSRC */
# ifdef lint
static char sccsid[] = "@(#)where.c 1.1 86/09/25 Copyright 1985, 1987 Sun Microsystems, Inc.";
/*
 *
	...
	char *within;
{
	...
	strcpy(within,qualpn+((bestlen == 1) ? 0 : bestlen));
	return 1;
}
