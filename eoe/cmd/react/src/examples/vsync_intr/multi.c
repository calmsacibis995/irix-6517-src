 ...
 * cpu: 1
 * intr_source: FRS_INTRSOURCE_VSYNC
 * n_minors: 20
...
int intr_source = FRS_INTRSOURCE_VSYNC;
...
process_for_master_frs(void* arg)
{
	 ...
	 * slaves = 2, 3
	 * number_of_slaves = 2
	 * period (intr_qualifier) = graphics pipe 0
	 */


	if ((frs = frs_create_master(1, intr_source, 0, 20, 2)) == NULL) {
