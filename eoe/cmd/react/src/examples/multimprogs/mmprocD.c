...
main(int argc, char** argv)
{
	frs_t* frs;
        ...
        /*
         * We want this process to cover a complete major frame.
         * We enqueue it on all minors, CONT on the first 3 minors,
         * and absolute RT on the last one.
         */
        ...
        enqdesc_list[3].minor = 3;
        enqdesc_list[3].disc = FRS_DISC_RT;


        /*
         * Enqueue on frs running host_processor,
         * Sequence 1 (second on queue),
         * enqueue list of length 4,
         * enqueue_list as specified above.
         */                
        if ((frs = enqueue_client(host_processor, 1, 4, enqdesc_list)) == NULL) {
                fprintf(stderr,
