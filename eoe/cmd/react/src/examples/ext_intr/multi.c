 ...
 * cpu: 1
 * intr_source: FRS_INTRSOURCE_EXTINTR
 * n_minors: 20
...
int intr_source = FRS_INTRSOURCE_EXTINTR;
 ...
 * of processes that will be joining, plus the number
 * of frame schedulers. In this case this is 9 processes
 * plus 3 frame schedulers = 12 waiters.
 */
