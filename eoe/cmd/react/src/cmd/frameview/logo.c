...
/* code in this file taken from the ideas in motion demo sample code */
...
/* code taken from the draw_logo file in the ideas in motion demo */
...
static void draw_single_cylinder() {
...
static void draw_double_cylinder() {
