...
/* #ident	"@(#)head:macros.h	1.3.4.1" */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/sccs/hdr/RCS/macros.h,v 1.10 1995/12/30 02:18:34 ack Exp $"
/*
...
extern struct stat64 Statbuf;
# define exists(file)		(stat64(file,&Statbuf)<0 ? 0:Statbuf.st_mode)
