...
#ident	"@(#)vi:port/ex_tune.h	1.12.1.1"
...
#define	ONMSZ		MAXPATHLEN	/* Option name size (can be filename)*/
...
#else
#define	HBLKS		2
#ifdef sgi 	/* LBLKS should be tied to HBLKS and BUFSIZ, not hardwired */
#define HSLOP	(MAXPATHLEN + 40)	/* rest of stuff in header */
#define LBLKS 	(((HBLKS * BUFSIZ) - HSLOP) / sizeof (short))
#define MAXLINES	((LBLKS * BUFSIZ) / sizeof (line))
#else	
#define	LBLKS		900
#endif	/* sgi */
#endif	/* VMUNIX */
...
#define	TUBECOLS	350	/* Number of screen columns for visual */
#define	TUBESIZE	70000	/* Maximum screen size for visual */
