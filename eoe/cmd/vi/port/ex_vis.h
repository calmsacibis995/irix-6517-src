...
var	unsigned char	vmacbuf[BUFSIZ];   /* Text of visual macro, hence nonnestable */
...
var	bool rewrite;
#ifdef sgi
var	bool forcewrap;		/* set when vgetline is forcing a new line
				 * using macpush; we have to switch the 
				 * behaviour of getbr to look at vmacp
				 * before vglobp */
#endif
