...
#define	SHFT	2		/* 3 */
#else
#ifndef sgi	/* this stuff is braindead, it hardwires 1K blocks. */
...
#else	/* sgi. The units of file I/O should match BUFSIZ!! Also, BUFSIZ
	 * must be a power of 2. */

#define	BLKMSK	0x7fff	/* blockno must fit in a short. */
#define	BNDRY	2
#define	INCRMT	BUFSIZ
#define	LBTMSK	(BUFSIZ - 2)
#define	NMBLKS	0x7ff8
#define	OFFBTS	13	/* WARNING: 2^OFFBTS must == BUFSIZ! */
#define	OFFMSK	(BUFSIZ - 1)
#define	SHFT	0
