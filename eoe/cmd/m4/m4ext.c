...
char	fnbuf[11*(PATH_MAX+1)];		/* holds file name strings */
...
struct wrap_info  *Wrapstr;             /* Header to the list of strings for "m4wrap" */
struct wrap_info  *Curr_str;            /* Pointer to current string for "m4wrap" */
