...
int		my_stream_opened=0,my_file_opened=0,
		NEAR my_umask=0664;
#ifndef THREAD
int		NEAR my_errno=0;
#endif
...
int (*error_handler_hook)(uint my_error,const char *str,myf MyFlags)=
    my_message_no_curses;
int (*fatal_error_handler_hook)(uint my_error,const char *str,myf MyFlags)=
  my_message_no_curses;
