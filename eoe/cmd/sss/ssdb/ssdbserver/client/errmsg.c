...
static char *client_errors[]=
{
  ...
  "Keine Verbindung zu lokalem MySQL Server (%d)",
  "Keine Verbindung zu MySQL Server auf %s (%d)",
  "Kann IP-Socket nicht anlegen (%d)",
  "Unbekannter MySQL Server Host (%s) (%d)",
...
char *client_errors[]=
{
  ...
  "Can't connect to local MySQL server (%d)",
  "Can't connect to MySQL server on %s (%d)",
  "Can't create IP socket (%d)",
