...
extern int my_printf_error _VARARGS((uint my_error, const my_string format,
				     myf MyFlags, ...));
...
extern void delete_dynamic_element(DYNAMIC_ARRAY *array, uint index);
extern void freeze_size(DYNAMIC_ARRAY *array);
#define dynamic_array_ptr(array,index) ((array)->buffer+(index)*(array)->size_of_element)
#define dynamic_element(array,index,type) ((type)((array)->buffer) +(index))
...
extern my_bool dynstr_set(DYNAMIC_STRING *str, my_string init_str);
