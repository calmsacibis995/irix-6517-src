...
int	inithdr;			/* Printing initial headers */
int	savedegid;			/* Saved effective grp ID from start */
int	ismailx;			/* prog called? 0=='Mail' 1=='mailx' */
int	sawnextcom;			/* saw a "next" command */
