...
#define	SHELL_XPG4	"/bin/sh"	/* Standard shell: XPG4 compliance */
#if defined(SVR3) || defined(_SVR4_SOURCE)
...
#define	XHELPFILE	"/usr/lib/mailx.help"
					/* Name of casual help file */
#define	THELPFILE	"/usr/lib/Mail.help.~"
#define	TXHELPFILE	"/usr/lib/mailx.help.~"
...
#define TMPDIR		"/tmp"		/* Default location of temp files */
