 ...
 *
 * $Id: ns_func.h,v 1.6 1997/11/15 20:31:04 jes Exp $
 */
...
extern int		sendfromto __P((int, void *, int, int,
					struct in_addr *, void *, int,
					mac_t));
struct sockaddr;
extern int		recvfromto __P((int, void *, int, int,
					struct sockaddr *, int,
