 ...
 *
 *
 * igmp.c,v 3.8.4.13 1997/06/06 21:41:09 fenner Exp
 */
...
static int	debug_kind __P((u_int type, u_int code));
    ...
    int recvlen;
{
    ...
    IF_DEBUG(DEBUG_PKT|debug_kind(igmp->igmp_type, igmp->igmp_code))
    ...
    int datalen;
{
    ...
    IF_DEBUG(DEBUG_PKT|debug_kind(type, code))
