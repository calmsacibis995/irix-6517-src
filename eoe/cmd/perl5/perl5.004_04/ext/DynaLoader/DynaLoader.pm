...
#  IRIX (SGI) uses different variations depending on ABI.
#  this version of Perl is compiled to use LD_LIBRARYN32_PATH
push(@dl_library_path, split(/:/, $ENV{LD_LIBRARYN32_PATH}))
    if $ENV{LD_LIBRARYN32_PATH};
...
LD_LIBRARY_PATH for SunOS, LD_LIBRARYN32_PATH for IRIX -n32 binaries).
