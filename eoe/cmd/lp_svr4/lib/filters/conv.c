 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/lib/filters/RCS/conv.c,v 1.1 1992/12/14 13:25:37 suresh Exp $"
...
#endif
{
	...
	for (n = 0; n < nitems; n++) {
	/* This statement is recoded to get around the C FrontEnd bug 
