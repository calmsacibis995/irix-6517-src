 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/lib/msgs/RCS/read_fifo.c,v 1.1 1992/12/14 13:31:48 suresh Exp $"
...
SyncUp:
    ...
    */
	...
	register FILE	*fp = fopen("./trace", "a");
	fprintf (fp, "MESSAGE:\n");
	fwrite (fbp->psave, 1, real_size, fp);
	fputs ("\n", fp);
	fclose (fp);
    }
#endif
