 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/include/RCS/lpd.h,v 1.1 1992/12/14 13:22:48 suresh Exp $ */
...
void      _lp_msg(int, long, int, va_list);
void	  canonize(char *, char *, char *);
void	  closeRemote(void);
void	  done(int);
void	  fatal(char *, ...);
void	  logit(int, char *, ...);
void      lp_fatal(int, long, int, ...);
void      lp_msg(int, long, int, ...);
