 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/filter/postscript/postio/RCS/ifdef.c,v 1.1 1992/12/14 13:18:12 suresh Exp $"
 ...
 */
    ...
    termio.c_oflag = 0;
    termio.c_cflag = HUPCL | CREAD | CS8 | stopbits | ((line != NULL) ? baudrate : (termio.c_cflag & CBAUD));
    termio.c_lflag = 0;
