...
# |-----------------------------------------------------------|
#
# $Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/filter/postscript/postmd/RCS/postmd.mk,v 1.1 1992/12/14 13:19:00 suresh Exp $
...
install : postmd
	...
	$(INSTALL) -c -s -m 775 -o $(OWNER) -g $(GROUP) postmd $(BINDIR) 
#	cp postmd $(BINDIR)
