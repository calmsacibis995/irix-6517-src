 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/cmd/lpsched/lpsched/RCS/rexec.c,v 1.1 1992/12/14 11:34:24 suresh Exp $"
...
#ifdef _RISCOS
	RSTATUS *		prs = ((pss->exec->flags & EXF_WAITJOB)
				       ? pss->exec->ex.request
				       : NULL);
#else  /* _RISCOS */
