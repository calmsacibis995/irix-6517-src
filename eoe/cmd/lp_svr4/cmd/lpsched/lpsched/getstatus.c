 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/cmd/lpsched/lpsched/RCS/getstatus.c,v 1.1 1992/12/14 11:33:29 suresh Exp $"
...
#ifdef _RISCOS
	schedlog ("Suspend %0x for status\n", md);
#else /* _RISCOS */
