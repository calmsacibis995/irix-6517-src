 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/cmd/cmds/RCS/lpmove.c,v 1.1 1992/12/14 11:28:34 suresh Exp $"
...
Errexit:	if (!wasrej) accept(argv[1]);
        ...
        LP_OUTMSG3(INFO, E_MOV_REQMOVED, nmove, argv[1], argv[2]);
    } else {
	for(i = 1; i < argc - 1; i++) {
        ...
        LP_OUTMSG2(INFO, E_MOV_MOVED, nmove, argv[argc-1]);
    }
