 ...
 * |-----------------------------------------------------------|
 */
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/lp_svr4/cmd/lpadmin/RCS/do_printer.c,v 1.1 1992/12/14 11:29:16 suresh Exp $"
...
void			do_printer ()
{
	...
	if (A && STREQU(A, NAME_LIST)) {
		if (label)
                        LP_OUTMSG1(INFO, E_ADM_PRINTER, label);
                else
