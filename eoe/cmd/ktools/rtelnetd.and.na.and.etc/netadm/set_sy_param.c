 ...
 *
 * Module Function:
 * 	Use RPC's to set synchronous parameters in a remote Annex.
 *
 * Original Author: Owain Phillips      Created on: November 16th 1993
 *
 * Revision Control Information:
 *
 * $Id: set_sy_param.c,v 1.2 1996/10/04 12:14:53 cwilson Exp $
 *
 * This file created by RCS from:
 * $Source: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/set_sy_param.c,v $
 *
 * Revision History:
 *
 * $Log: set_sy_param.c,v $
 * Revision 1.2  1996/10/04 12:14:53  cwilson
 * latest rev
 *
 * Revision 1.1  1994/01/06  15:37:25  wang
 * Initial revision
 *
 *
...

#define RCSDATE $Date: 1996/10/04 12:14:53 $
#define RCSREV  $Revision: 1.2 $
#define RCSID   "$Header: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/set_sy_param.c,v 1.2 1996/10/04 12:14:53 cwilson Exp $"
#ifndef lint
...
extern u_long get_long(), get_unspec_long();
...
set_sy_param(Pinet_addr, device_type, line_number, cat, number, type, Pdata)
...

{
    ...
    /* Set up outgoing iovecs.
       ...
       outgoing[5] contains the sync line param. */
    ...
    switch (type)
	    ...
	    outgoing[5].iov_len = sizeof(u_short) + sizeof(u_long);
            break;
    ...
    return rpc(Pinet_addr, RPROC_SET_SYNC_PARAM, OUTGOING_COUNT, outgoing,
	       (char *)0, (u_short)0);
