 ...
 *
 * $Header: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/get_ln_param.c,v 1.3 1996/10/04 12:12:45 cwilson Exp $
 *
 * This file created by RCS from $Source: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/get_ln_param.c,v $
 *
 * Revision History:
 *
 * $Log: get_ln_param.c,v $
 * Revision 1.3  1996/10/04 12:12:45  cwilson
 * latest rev
 *
...
#define RCSDATE $Date: 1996/10/04 12:12:45 $
#define RCSREV  $Revision: 1.3 $
#define RCSID   "$Header: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/get_ln_param.c,v 1.3 1996/10/04 12:12:45 cwilson Exp $"
#ifndef lint
