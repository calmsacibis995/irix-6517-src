 ...
 * $Id: get_if_param.c,v 1.2 1996/10/04 12:12:36 cwilson Exp $
 *
 * This file created by RCS from
 * $Source: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/get_if_param.c,v $
 * 
 * Revision History:
 * $Log: get_if_param.c,v $
 * Revision 1.2  1996/10/04 12:12:36  cwilson
 * latest rev
 *
...
#define RCSDATE $Date: 1996/10/04 12:12:36 $
#define RCSREV  $Revision: 1.2 $
#define RCSID   "$Header: /proj/irix6.5.7m/isms/eoe/cmd/ktools/rtelnetd.and.na.and.etc/netadm/RCS/get_if_param.c,v 1.2 1996/10/04 12:12:36 cwilson Exp $"
#ifndef lint
