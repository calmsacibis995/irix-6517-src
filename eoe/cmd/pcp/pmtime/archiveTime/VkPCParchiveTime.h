...
//
// $Id: VkPCParchiveTime.h,v 1.4 1997/08/21 04:31:06 markgw Exp $
//

//////////////////////////////////////////////////////////////
//
// Header file for VkPCParchiveTime
//
...
//
//////////////////////////////////////////////////////////////
#ifndef VKPCPARCHIVETIME_H
#define VKPCPARCHIVETIME_H
...
//---- VkPCParchiveTime class declaration

class VkPCParchiveTime: public VkWindow { 

  public:

    VkPCParchiveTime( const char * name, 
                      ArgList args = NULL,
                      Cardinal argCount = 0 );
    ~VkPCParchiveTime();
  ...
  protected:
    ...
    class ArchiveTimeForm *_archiveTimeForm;
    ...
    virtual void boundsActivate ( Widget, XtPointer );
  ...
  private:
    ...
    static void boundsActivateCallback ( Widget, XtPointer, XtPointer );
    ...
    static String      _defaultVkPCParchiveTimeResources[];
