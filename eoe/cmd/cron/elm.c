...
#ident	"$Header: /proj/irix6.5.7m/isms/eoe/cmd/cron/RCS/elm.c,v 1.8 1999/11/19 23:51:38 bitbug Exp $"
/**************************************************************************
...
static struct notice	*current=NULL;
...
#ifdef sgi /* make index static so as to avoid a collision with libc's */
