...
/*
 * $Log: co.c,v $
 * Revision 1.7  1997/03/31 21:26:46  msf
 ...
 *
 * Revision 1.1  1996/10/03  17:34:17  pj
 ...
 *
 * Revision 1.6.1.2  1996/06/28  21:40:44  msf
 * Cast 2nd argument of pairnnames to cont char **.
 *
 * Revision 1.6.1.1  1996/06/25  23:29:49  msf
...
mainProg(coId, "co", "$Id: co.c,v 1.7 1997/03/31 21:26:46 msf Exp $")
{
...
#	endif
	...
	if (pairnames(argc, (const char **)argv,
	    lockflag?rcswriteopen:rcsreadopen, true, false)  <=  0)
		continue;
