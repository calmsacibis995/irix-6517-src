/* RCS compile-time configuration */
	...
	/* $Id: conf.h,v 1.8 1997/03/31 21:26:47 msf Exp $ */
...
#define has_seteuid 1 /* Does seteuid() work?  See Posix 1003.1a Draft 5.  */
#define has_setreuid 0 /* Does setreuid() work?  Only checked if !has_seteuid */
...
/* Do struct stat s and t describe the same file attributes (contents)?
 * Answer d if unknown.
 */
#define same_attr(s,t,d) ((s).st_ctime==(t).st_ctime && (s).st_size==(t).st_size)
#define has_utimbuf 1 /* Does struct utimbuf work?  */
#define CO "/usr/sbin/co" /* name of 'co' program */
...
#define MERGE "/usr/sbin/merge" /* name of 'merge' program */
#define TMPDIR "/var/tmp" /* default directory for temporary files */
...
/* <stdio.h> */
#ifndef L_tmpnam
#define L_tmpnam 32 /* power of 2 > sizeof("/var/tmp/xxxxxxxxxxxxxxx") */
#endif
#ifndef SEEK_SET
#define SEEK_SET 0
#endif
