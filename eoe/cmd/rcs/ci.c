...
/*
 * $Log: ci.c,v $
 * Revision 1.14  1997/03/31 21:26:44  msf
 ...
 *
 * Revision 1.13.1.2  1996/06/28  21:38:53  msf
 * Cast 2nd argument of pairnames to const char **.
 *
 * Revision 1.13.1.1  1996/06/25  20:01:14  msf
...
mainProg(ciId, "ci", "$Id: ci.c,v 1.14 1997/03/31 21:26:44 msf Exp $")
{
	...
	switch (pairnames(argc, (const char **)argv, rcswriteopen, mustread,
	        false)) {
        case -1:                /* New RCS file */
