...
/*
 * $Log: rcsmerge.c,v $
 * Revision 1.9  1997/03/31 21:29:17  msf
 ...
 *
 * Revision 1.2  1997/01/27  22:11:41  msf
 * Merge a bug fix from other (kudzu) LOD: initialize workptr to NULL,
 * in case pairnames() fails and workptr is not set.
 *
 * Revision 1.1  1996/10/03  17:34:26  pj
 ...
 *
 * Revision 1.5.1.2  1996/06/29  00:12:59  msf
 * Cast 2nd argument to pairnames to const char **.
 *
 * Revision 1.5.1.1  1996/06/25  18:59:37  msf
...
mainProg(rcsmergeId, "rcsmerge", "$Id: rcsmerge.c,v 1.9 1997/03/31 21:29:17 msf Exp $")
{
	...
	if (!nerror) {
	    ...
	    if (0 < pairnames(argc, (const char **)argv, rcsreadopen, true,
		false)) {
