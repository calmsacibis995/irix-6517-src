...
Id='$Id: conf.sh,v 1.2 1997/03/31 21:26:49 msf Exp $'
...
for h in \
	...
	pwd setjmp siginfo signal stdlib string \
...
: configuring same_attr
echo "/* Do struct stat s and t describe the same file attributes (contents)?"
echo " * Answer d if unknown."
echo " */"
echo "#define same_attr(s,t,d) ((s).st_ctime==(t).st_ctime && (s).st_size==(t).st_size)"
