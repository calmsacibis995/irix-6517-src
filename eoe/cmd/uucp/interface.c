...
int	(*Read)(int, void *, unsigned) = read,
	(*Write)(int, const void *, unsigned) = write,
	(*Ioctl)(int, int, ...) = ioctl,
	(*Setup)(int, int *, int *) = usetup,
...
struct Interface {
	...
	int	(*IN_read)(int, void *, unsigned);  
	int	(*IN_write)(int, const void *, unsigned);
	int	(*IN_ioctl)(int, int, ...);
	int	(*IN_setup)(int, int *, int *);	/* called before 1st i/o op */
	int	(*IN_teardown)(int, int, int);	/* called after last i/o op */
} Interface[] = {
			/* vanilla UNIX */
