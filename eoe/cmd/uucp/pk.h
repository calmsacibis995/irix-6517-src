...
extern void	pkcntl(int, struct pack *);
extern struct pack *pkopen(int, int);
extern void	pkclose(struct pack *);
extern int	pkread(struct pack *, char *, int);
extern int	pkwrite(struct pack *, char *, int);
extern int	pkaccept(struct pack *);
extern void	pkxstart(struct pack *, char, int);
extern void	pkgetpack(struct pack *);
extern int	pkcget(int, char *, int);
extern void	pkdata(char, unsigned short, struct pack *, char **);
extern void	pkoutput(struct pack *);
extern int	pksack(struct pack *);
extern void	pkzero(char *, int);
extern void	pkreset(struct pack *);
extern int	chksum(char *, int);
extern int	pksize(int);
