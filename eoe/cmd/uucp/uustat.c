...
int sortcnt = -1;
extern int machcmp();
int _age(char *, char *);		/* find the age of a file */

static void printit(struct m *);
static void lckpid(void);
static struct m *machine(char *);
static void uprocessC(char *, char *);
static void kprocessC(char *, char *);
static off_t fsize(char *, char *, char *);
