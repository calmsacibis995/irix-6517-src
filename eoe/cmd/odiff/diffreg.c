...
static fetch(long *f, int a, int b, FILE *lb, char *s, int oldfile);
...
asciifile(f)
	FILE *f;
{
	/* sgi rewritten: previous asciifile(){} contents discarded - pj */
	char buf[BUFSIZ];
	int cnt, i;
