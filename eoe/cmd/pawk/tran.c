...
uchar   **CONVFMT;	/* Conversion format when going number --> string */
...
uchar *r_getsval(vp, print)
register Cell *vp;
int print;		/* flag indicating we should use OFMT rather than
			 * CONVFMT when converting numbers to strings.
			 */
{
	uchar s[100];
