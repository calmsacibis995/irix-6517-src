/* $Header: /proj/irix6.5.7m/isms/eoe/cmd/patch/RCS/common.h,v 1.1 1996/01/17 02:44:13 cleo Exp $
 *
 * $Log: common.h,v $
 * Revision 1.1  1996/01/17 02:44:13  cleo
 * initial checkin.
 *
 * Revision 1.5  1995/11/07  16:41:32  lguo
 * Added include file libgen.h for dirname().
 *
 * Revision 1.3  1995/10/11  18:32:43  lguo
 * No Message Supplied
 *
...
EXT bool first INIT(TRUE);
EXT bool output INIT(FALSE);
...
/* Data structure for use of multiple patches and specified output file */
EXT struct intermediate {
    char *orig;                          /* original file to be patched */
    char *interm;                        /* intermediate file */
    struct intermediate *next;           /* next original file */
} *im_table;
